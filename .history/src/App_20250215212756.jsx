...
const lenisInstance = lenis({
  duration: 1.4, // Duration of the scroll
  ...
  mouseMultiplier: 1, // Speed multiplier for mouse devices
  touchThreshold: 10, // Threshold for touch devices
  mouseThreshold: 10, // Threshold for mouse devices
});
