...
void main() {
    ...
    vec4 c4 = vec4(0.9019, 0.8627, 0.9961, 1.0); // #E7DCFE color (same as c3 for uniformity)
    
    vec4 c5 = vec4(0.6784, 0.8471, 0.9010, 1.0);
    vec4 c6 = vec4(0.8314, 0.9333, 0.9608, 1.0);
    
    vec4 c7 = vec4(0.2, 0.2, 0.2, 1.0); // Dark grey color
    vec4 c8 = vec4(0.3, 0.3, 0.3, 1.0); // Slightly lighter dark grey color
    ...
    finalColor = mix(finalColor, colorDarkGrey, smoothstep(2.0, 2.5, uColorChange)); // Incorporate dark grey
