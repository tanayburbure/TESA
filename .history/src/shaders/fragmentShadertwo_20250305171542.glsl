...
void main() {
    ...
    vec4 c3 = vec4(1.0, 0.9608, 0.8706, 1.0); // Modified to create a good yellow effect
    vec4 c4 = vec4(1.0, 0.9608, 0.8706, 1.0); // Modified to create a good yellow effect
    ...
    vec4 colorYellow = mix(c3, c4, v); // Modified to create a good yellow effect
