...
void main() {
    ...
    vec4 c4 = vec4(0.9019, 0.8627, 0.9961, 1.0); // #E7DCFE color (same as c3)
    ...
    // New: Gradual transition to dark grey when uColorChange > 2.5
    finalColor = mix(finalColor, colorDarkGrey, smoothstep(2.5, 3.5, uColorChange));
