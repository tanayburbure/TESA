...
const ExperienceCard = memo(function ExperienceCard({ name, job, paragraph }) {
  ...
  return (
    <motion.div
      ref={cardRef}
      className="w-[85%] select-none mx-auto bg-white overflow-hidden rounded-2xl shadow-sm mb-10 border border-gray-100"
      layout
      role="region"
      aria-label={name}
    >
      <motion.div className="p-6 sm:p-8" layout>
        ...
        <p className="text-md font-semibold text-[#3B6654]">
          <span className=" text-zinc-600 font-regular">Placed at</span> {job}
        </p>
  ...
  return (
    <div className="w-full">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-center sm:text-5xl font-[font3] font-semibold m-20 tracking-tight text-gray-900">
