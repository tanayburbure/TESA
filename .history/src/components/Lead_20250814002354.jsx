...
const Header = () => {
    return (
        <div className="max-w-7xl bg-transparent relative mx-auto py-20 md:py-28 px-4 w-full left-0 top-0">
...
const ProductCard = ({ product }) => {
    return (
        <motion.div
            whileHover={{ y: -20 }}
            className="group/product no-draw h-[29rem] w-[32rem] top-0 relative shrink-0 "
            style={{
                marginRight: "2rem",
