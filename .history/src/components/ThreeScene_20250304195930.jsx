    ...
    <div className="w-full">
      <div className="landing w-screen relative flex flex-col">
        <div className="flex items-center justify-center">
          <h2 className="text-[2.5vw] z-[3] font-bold text-zinc-800 text-center absolute cursor-pointer">WE CREATE. YOU CELEBRATE.</h2>
          <h1 className='text-[5.5vh] text-center absolute font-bold pt-40 z-[3] '><span className='font-medium pr-4 mb-2' ref={blinkRef}>[</span> WE ARE </h1>
        </div>
