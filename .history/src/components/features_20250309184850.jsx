...
function Highlights() {
    return (
        <div className='flex flex-col mt-[25vh] bg-zinc-900 h-[85vh] items-center justify-start text-white'>
            ...
            <div className="flex gap-8 mt-24">
                <div className="h-[13vw] w-[19vw] px-4 mx-4 bg-[#FFFFFF] text-zinc-800 rounded-lg text-center">
                    ...
                    <button className='border border-zinc-700 rounded-full px-5 text-center pb-2 pt-1 mt-4'>View page</button>
                </div>
                <div className="h-[13vw] w-[19vw] px-4 mx-4 bg-[#FFFFFF] text-zinc-800 rounded-lg text-center">
