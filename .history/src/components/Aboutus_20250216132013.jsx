  ...
  return (
    <div className='text-white h-[100vh] flex flex-col px-12 items-center justify-center'>
      <div className='flex justify-between'>
        ...
        <p className='w-[60%] text-[2.6vh] tracking-tight leading-[3.5vh] text-zinc-700'>The Telecom Engineers Student Association (TESA) has proudly upheld its legacy for many years. <br />
