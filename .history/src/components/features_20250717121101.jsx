...
function Highlights() {
    return (
        <div className='flex flex-col h-[90vh] items-center justify-center text-white'>
            <h1 className='text-[6.8vhvw] font-[font4] tracking-wide font-semibold'>Features of our website</h1>
