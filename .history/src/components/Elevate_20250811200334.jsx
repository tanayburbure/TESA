...
const ExperienceCard = memo(function ExperienceCard({ name, job, paragraph }) {
  ...
  return (
    <motion.div
      ref={cardRef}
      className="w-full bg-white overflow-hidden rounded-2xl shadow-sm mb-6 border border-gray-100"
      layout
      role="region"
      aria-label={name}
    >
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          {/* Person logo / avatar */}
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-indigo-100 text-indigo-700 ring-2 ring-indigo-200 shrink-0">
            <svg
              width="18"
              height="18"
              viewBox="0 0 24 24"
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        {/* <p className="text-gray-500 mt-1">Insights from recent placements and interviews</p> */}
      </div>
