...
const ThreeScene = () => {
  ...
  const h1Ref = useRef(null); // Added ref for h1 element
  const h2Ref = useRef(null); // Added ref for h2 element
  ...
  useEffect(() => {
    ...
    // Animation for h2 and h1
    gsap.to(h1Ref.current, { opacity: 0, duration: 0 }); // Initially hide h1
    ...
    <div className="w-full">
      <div className="landing w-screen relative flex flex-col">
        <div className="flex items-center justify-center">
          <h2 className="text-[2.5vw] z-[3] font-bold text-zinc-800 text-center absolute cursor-pointer pt-12" ref={h2Ref}>WE CREATE. YOU CELEBRATE.</h2>
          <h1 className='text-[5.5vh] text-center absolute font-bold pt-[50vh] z-[3]' ref={h1Ref}><span className='font-medium pr-4 mb-2' ref={blinkRef}>[</span> WE ARE </h1>
        </div>
