  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="h-screen w-full flex items-center justify-center">
        <div className="w-[42%] pl-6 no-draw">
            <h3 className="font-[font3] font-regular text-[3.1vh]">Presented by</h3>
            <h2 className="font-[font4] text-[3.5vh] mt-3 font-regular">Electronics and Telecommunication Department</h2>
        </div>
