  ...
  return (
    <div className=" font-sans p-4 mt-32">
      <div className="w-full ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mx-auto w-[70%] gap-12 text-black mt-12">
          <CometCard className="bg-white h-52 rounded-xl flex flex-col items-center justify-center shadow-2xl shadow-green-500/10">
            <img
              src="./images/s1.png"
            ...
            />
            <h2 className="text-xl font-semibold font-[font2] text-center text-gray-800">500+ Students Placed</h2>
          </CometCard>
          ...
          <CometCard className="bg-white rounded-xl flex flex-col items-center justify-center p-6 shadow-2xl shadow-green-500/10">
            <img
              ...
              onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/96x96/cccccc/FFFFFF?text=Error'; }}
            />
            <h2 className="text-xl font-semibold font-[font2] text-center text-gray-800">20+ MNC's</h2>
          </CometCard>
          ...
          <CometCard className="bg-white rounded-xl flex flex-col items-center justify-center p-6 shadow-2xl shadow-green-500/10">
            <img
              ...
              onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/96x96/cccccc/FFFFFF?text=Error'; }}
            />
            <h2 className="text-xl font-semibold font-[font2] text-center text-gray-800">10+ Core Recruitments</h2>
          </CometCard>
        </div>

        {/* Action buttons at the bottom */}
        <div className="flex justify-center gap-4 mt-12">
          <button className="bg-[#4c8069] text-white font-semibold px-8 py-3 rounded-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-105 shadow-lg">
            View Placements
          </button>
