...
function Aboutus() {
  ...
  return (
    <div className='h-[120vh] relative bg-red-300 flex'>
      <ThreeScene />
      <div className='absolute bg-blue-300 px-10 text-center flex flex-col items-center justify-center'>
        
        <div className='flex bg-green-300 flex-col items-center mt-32'>
          
          <p ref={paragraphRef} className='w-[75%] text-[2.8vh] mt-[27vh] tracking-tight leading-[3.7vh] text-zinc-400'>The Telecom Engineers Student Association (TESA) has proudly upheld its legacy for many years. <br />
        ...
        <div className='mt-12 flex gap-16 bg-red-900'>
