...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    // Geometry/Material logic unchanged
    ...
    <div className="w-full">
      <div className="landing w-screen relative flex flex-col">
        <div className="flex items-center justify-center">
          <h1
            ref={h1Ref}
            // Keep heading above canvas if desired (z-[50]); lower it if you want canvas above text
            className="text-[7vh] font-[font4] text-center absolute font-semibold tracking-tight pt-[65vh] z-[50]"
          >
        ...
        {/* Absolute, sized container so renderer's absolute canvas has space and higher z-index than Home */}
        <div
          ref={canvasRef}
          className="absolute top-0 left-0 w-full h-[120vh] z-[40] pointer-events-none"
        />
      </div>
    </div>
  );
