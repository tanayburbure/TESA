  ...
  useEffect(() => {
    ...
    gsap.to(h2Ref.current, {
      ...
      scrollTrigger: {
        ...
        scrub: true,
        onComplete: () => {
          gsap.to(h2Ref.current, { opacity: 1, duration: 0.5 }); // Reverse h2 opacity after h2 animation completes
          gsap.to(h1Ref.current, { opacity: 1, duration: 0.5 }); // Show h1 after h2 animation completes
        },
      },
    });

    // Ensure h1 is visible initially
    gsap.set(h1Ref.current, { opacity: 0 }); // Set initial opacity of h1 to 0
    ...
    <div className="w-full">
      <div className="landing w-screen relative flex flex-col">
        <div className="flex items-center justify-center">
          ...
          <h1 ref={h1Ref} className='text-[5.5vh] opacity-0 text-center absolute font-bold pt-[50vh] z-[3] '><span className='font-medium pr-4 mb-2' ref={blinkRef}>[</span> WE ARE </h1>
        </div>
