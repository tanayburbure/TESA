...
const Floating = () => {
  ...
  const [logos] = useState([
    ...
    { id: 1, alt: 'TypeScript', imageUrl: 'https://placehold.co/64x64/007ACC/FFFFFF?text=TS', top: 20, left: 10, filterColor: '#007ACC', animationDelay: '0s' },
    { id: 2, alt: 'R', imageUrl: 'https://placehold.co/64x64/276DC3/FFFFFF?text=R', top: 30, left: 80, filterColor: '#276DC3', animationDelay: '0.5s' },
    { id: 3, alt: 'Rust', imageUrl: 'https://placehold.co/64x64/E4482B/FFFFFF?text=Rust', top: 75, left: 30, filterColor: '#E4482B', animationDelay: '1s' },
    { id: 4, alt: 'Bitcoin', imageUrl: 'https://placehold.co/64x64/F7931A/FFFFFF?text=₿', top: 60, left: 90, filterColor: '#F7931A', animationDelay: '1.5s' },
    { id: 5, alt: 'VS Code', imageUrl: 'https://placehold.co/64x64/007ACC/FFFFFF?text=VS', top: 85, left: 50, filterColor: '#007ACC', animationDelay: '2s' },
  ]);
        ...
        {logos.map(logo => (
          <div
            ...
            style={{
              ...
              left: `${logo.left}%`,
              top: `${logo.top}%`,
              filter: `drop-shadow(0 0 10px ${logo.filterColor})`,
