...
function Nav() {
  ...
  useEffect(() => {
    gsap.to(titleRef.current, {
      ...
      scrollTrigger: {
        ...
        start: 'top 30 80', // Start animation when the element's top reaches the center
        end: 'top 30 100', // End before it reaches the top
        scrub: 1,
  ...
  return (
    <div className='relative pt-8 px-8 h-screen'>
      <div className='absolute top-4 flex items-center px-3 z-[99999999] top-2 py-[2.2vh]'>
