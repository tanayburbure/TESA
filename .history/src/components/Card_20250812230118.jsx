    ...
    <div className=" font-sans p-4 mt-32">
      <div className="w-full ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mx-auto w-[70%] gap-12 text-black mt-12">
          <CometCard className="bg-white rounded-xl flex flex-col items-center justify-center shadow-2xl shadow-green-500/10">
  <div 
    className="h-24 w-24 mb-4 bg-center bg-contain bg-no-repeat"
    style={{ backgroundImage: "url('./images/s1.png')" }}
    aria-label="Students Placed Icon"
  />
