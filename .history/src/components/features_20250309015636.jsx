    ...
    return (
        <div className='flex flex-col mt-8 bg-zinc-900 h-[80vh] items-center justify-start text-white'>
            ...
            <div className="flex gap-4 mt-24">
                <div className="h-[12vw] w-[18vw] px-4 mx-4 bg-[#EBEBEB] text-zinc-700 rounded-lg text-center">
                    <img src="" alt="" />
                    <h2>Interveiw Exp</h2>
                ...
                <div className="h-[12vw] w-[18vw] mx-4 px-4 bg-[#EBEBEB] text-zinc-700 rounded-lg text-center">
                    <img src="" alt="" />
                    <h2>Interveiw Exp</h2>
