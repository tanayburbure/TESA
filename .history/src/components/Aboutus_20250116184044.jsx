...
function Aboutus() {
  return (
    <div className='text-white h-[90vh] px-24 pt-32'>
        <h1 className='text-[6vh] font-bold'>WE ARE TESA</h1>
        <h3 className='text-[2.5vh]'>The Telecom Engineers Student Association has been carrying on its legacy for many years.</h3>
        <br />
        <p className='pt-12 pr-20 text-[2.3vh]'>Telecom Engineer Students Association (TESA) was first established in the year 2012 under the Electronics and Telecommunication Engineering Department (ENTC), AISSMS IOIT. This committee was established under the guidance of respective Principal sir, department HOD, TESA chairperson(s) and other faculty members for the maximum participation, overall development of students which involved showcasing their talent and providing them a platform to reveal their hidden potentials and skills through various domains like Technical, Cultural and Sports. Like every year students from Electronics and Telecommunication Department and also from other departments and AISSMS Society.
        <br />
