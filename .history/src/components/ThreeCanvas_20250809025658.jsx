  ...
  return (
    <>
      ...
      <div className="landing h-screen">
        <img src="./TESA3.png" alt="" />
        <div className="flex flex-col items-center justify-center z-50">
          <h3 className="text-zinc-700 font-semibold text-[1.8vw] ">TELECOM ENGINEER STUDENTS ASSOCIATION</h3>
          <h2
            className="text-[2.5vw] z-[99] font-bold text-center cursor-pointer"
          >
