...
function Nav() {
  ...
  useEffect(() => {
    ...
    gsap.to(titleRef.current, {
      x: '-80px', // Reduced distance to move toward the image
      y: '2px', // Slight vertical adjustment to align better with image center
      opacity: 0.8,
      duration: 0.8,
      ease: 'power2.in',
      delay: 2,
  ...
  return (
    <div className='fixed w-screen pt-16 px-8 z-[9999]'>
      ...
      <div className='fixed top-8 left-8 flex items-center'>
        ...
        />
        <div className='h-12 w-24 mb-2 overflow-hidden relative'>
          <h2 
            ref={titleRef} 
            className='select-none font-[font1] text-zinc-900 font-semibold text-[4.4vh] absolute'
