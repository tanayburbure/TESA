    ...
    <div className="h-[75vh] lg:h-[50vh] md:h-[73vh] overflow-hidden">
      ...
      <div className="py-[3vh] lg:flex lg:justify-between lg:items-center lg:pl-20">
        ...
        <div className="flex flex-col items-center lg:ml-12">
          <h2 className="text-zinc-400 font-[font1] text-[3.3vh] text-center mb-8 lg:text-[4vh]">
            SOCIALS
          </h2>
          <div className="flex gap-8 text-[5.5vw] lg:text-[1.5vw]">
            <a
              className="relative  lg:p-8 lg:border-[1px] lg:border-[#2A2929] lg:overflow-hidden lg:hover:scale-110 lg:rounded-full lg:bg-[#2A2929] transition-all duration-300 group"
