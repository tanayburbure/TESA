...
// Export the reusable CometCard component
...
// Keep the original demo component
  ...
  return (
    <div className="flex items-center justify-center ">
      <motion.div
        ...
        className={cn(
          "w-80 rounded-2xl bg-[#1F2121] p-4 flex flex-col items-center"
        )}
      >
        ...
        <div className="w-full mt-3 px-1 font-mono text-white text-xs">
