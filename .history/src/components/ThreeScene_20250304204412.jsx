  ...
  useEffect(() => {
    ...
    gsap.to(h2Ref.current, {
      ...
      scrollTrigger: {
        ...
        scrub: true,
        onComplete: () => {
          gsap.set(h1Ref.current, { display: "block" }); // Make h1 visible before animating
    ...
    <div className="w-full">
      <div className="landing w-screen relative flex flex-col">
        <div className="flex items-center justify-center">
          ...
          <h1 ref={h1Ref} className="text-[5.5vh] text-center absolute font-bold pt-[50vh] z-[3] hidden opacity-0">
