  ...
  return (
    <div className="wrapper relative overflow-hidden">
      <div ref={sectionRef} className="relative h-screen w-full overflow-hidden">
        <h1
          className="text-[#3B6654] text-[11vw] font-semibold tracking-[-1vh] absolute top-[37%] left-[14vw] font-[font3]"
        ...
        >
          ...
          <div className="border-t border-[#313131] h-[4vh] w-full absolute left-[8vw] top-[41vh]"></div>
          <div className="border-t border-[#313131] h-[1px] w-full absolute left-[8vw] top-[58.5vh]"></div>
