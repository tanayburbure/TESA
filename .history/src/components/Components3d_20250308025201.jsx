    ...
    <div>
      <div ref={containerRef} style={{ height: '140vh' }} className="text-center text-white pt-[30vh] bg-[#EBEBEB] relative">
        <div 
          ...
          style={{
            background: '#18181B',
            clipPath: 'polygon(0% 100%, 100% 100%, 100% 0%, 85% 15%, 70% 5%, 55% 12%, 40% 2%, 25% 15%, 0% 0%)',
        ...
        <style>
          {`
            @keyframes wave {
              0%, 100% {
                clip-path: polygon(0% 100%, 100% 100%, 100% 0%, 85% 15%, 70% 5%, 55% 12%, 40% 2%, 25% 15%, 0% 0%);
              }
              50% {
                clip-path: polygon(0% 100%, 100% 100%, 100% 0%, 85% 10%, 70% 15%, 55% 5%, 40% 12%, 25% 8%, 0% 0%);
              }
            }
          `}
        </style>
