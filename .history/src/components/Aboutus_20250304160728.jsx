...
function Aboutus() {
  ...
  return (
    <div className='text-white h-[100vh] bg-green-200 relative flex flex-col px-12 items-center justify-center'>
      <ThreeScene />
      <div className='absolute'>
        <div className='flex justify-between mt-32'>
          ...
          <p ref={paragraphRef} className='w-[60%] text-[2.6vh] pr-8 tracking-tight leading-[3.5vh] text-zinc-800'>The Telecom Engineers Student Association (TESA) has proudly upheld its legacy for many years. <br />
