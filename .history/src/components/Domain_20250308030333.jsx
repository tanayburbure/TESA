...
const Domain = () => {
  ...
  return (
    <div className='h-[80vh] -mt-4 flex flex-col items-center justify-center'>
      ...
      {/* Hover text */}
      <motion.h1
        className='text-[20vh] mt-8 text-zinc-500 font-medium tracking-tight w-full text-center'
        initial={{ opacity: 0.7 }}
        animate={{ opacity: 1 }}
