...
const CardTitle = ({ children, className }) => (
  <h4 className={cn("text-zinc-900 font-bold tracking-wide mt-1 font-[font2]", className)}>{children}</h4>
);

const CardDescription = ({ children, className }) => (
  <p className={cn("mt-2 text-zinc-500 tracking-wide leading-relaxed text-md font-[font2] leading-5.5", className)}>{children}</p>
);
