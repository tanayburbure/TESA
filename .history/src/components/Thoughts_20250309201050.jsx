...
function Thoughts() {
  return (
    <div className='h-[100vh] text-white bg-zinc-900'>
      <h1 className='text-[6vh] font-semibold text-center overflow-x-auto whitespace-wrap font-[font3]'>Thoughts of Our STUDENTS</h1>
      <div className='flex  gap-12 mt-12 p-4 '>
        {students.map((student, index) => (
          <div key={index} className="card min-w-[300px] max-w-sm h-[70vh] bg-[#2A2929] rounded-lg overflow-hidden shadow-lg pt-4 px-1"> 
            <img
