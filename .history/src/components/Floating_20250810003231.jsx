...
const Floating = () => {
  ...
  const [logos] = useState([
    ...
    { id: 1, alt: 'Vscode', imageUrl: './vscode.png', top: 25, left: 25, filterColor: '#007ACC', animationDelay: '0s' },
    { id: 2, alt: 'Chip', imageUrl: './chip.png', top: 12, left: 60, filterColor: '#276DC3', animationDelay: '0.5s' },
    { id: 3, alt: 'radio', imageUrl: './radio.png', top: 70, left: 20, filterColor: '#E4482B', animationDelay: '1s' },
    { id: 4, alt: 'Python', imageUrl: './python.png', top: 75, left: 68, filterColor: '#F7931A', animationDelay: '1.5s' },
  ]);
  ...
  return (
    <div className="absolute inset-0 z-[999] h-screen w-screen overflow-hidden font-inter">
