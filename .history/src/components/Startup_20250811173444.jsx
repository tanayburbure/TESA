  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className=""
      >
        {/* CHANGED: Added -ml-20 to move first row 20vh to the left */}
        <motion.div className="flex flex-row-reverse space-x-reverse space-x-20 mb-20 -ml[80vh]">
        ...
        {/* CHANGED: Added ml-20 to move second row 20vh to the right */}
        <motion.div className="flex flex-row mb-20 space-x-20 ml-20">
        ...
        {/* CHANGED: Added -ml-20 to move third row 20vh to the left */}
        <motion.div className="flex flex-row-reverse space-x-reverse space-x-20 -ml-20">
