...
export default function HamburgerMenu() {
  ...
  return (
   <div className=' fixed top-6 right-6 z-[99999]'>
    ...
    >
      {/* Fixed container for lines - positioned absolutely to stay in original spot */}
      <div className="absolute top-8 right-8 w-0 h-0 flex justify-center items-center transform -translate-x-0">
