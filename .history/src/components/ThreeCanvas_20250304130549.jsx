...
const ThreeCanvas = () => {
  ...
  return (
    <>
      ...
      <div className="landing relative flex justify-center items-end">
        <img className="opacity-0" src="./TESA3.png" alt="Logo" />
        <h3 className="text-black absolute  top-20">Telecom Engineer Students Association</h3>
      </div>
    </>
  );
};
