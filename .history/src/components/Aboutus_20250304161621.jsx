...
function Aboutus() {
  ...
  return (
    <div className='text-white h-[100vh] bg-green-200 relative flex flex-col  items-center justify-center'>
      <ThreeScene />
      <div className='absolute px-10'>
        <h2 className="text-[2.5vw] font-bold text-zinc-800 text-center relative -top-40 cursor pointer">WE CREATE. YOU CELEBRATE.</h2>
        <div className='flex justify-between mt-20'>
          <h1 className='text-[5.5vh] text-zinc-900 font-bold pt-2 '><span className='font-medium pr-4 mb-2' ref={blinkRef}>[</span> WE ARE </h1>
          <p ref={paragraphRef} className='w-[60%] text-[2.7vh] pr-8 tracking-tight leading-[3.5vh] text-zinc-800'>The Telecom Engineers Student Association (TESA) has proudly upheld its legacy for many years. <br />
