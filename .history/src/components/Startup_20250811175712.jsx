...
const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-28 px-4 w-full left-0 top-0">
      ...
      <h3 className="pt-2 text-2xl font-[font3]">presented by <span className="text-[#3B6654] font-bold">TESA</span></h3>
      <h3 className="text-2xl font-[font1] pt-2 font-semibold">INNOVATE | COLABORATE | TRANSFORM</h3>
      <button className="z-[999]" href="">Add your Start-up</button>
    </div>
  );
};
