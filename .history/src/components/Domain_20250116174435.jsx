  ...
  return (
    <div className='h-[28vw] mt-20'>
      <div className='flex gap-4 items-center justify-center'>
        <img 
          className='h-16 w-24 rounded grayscale transition-all duration-[4000ms] ease-in-out hover:grayscale-0 hover:scale-110 cursor-pointer'
      ...
      <h1 className='text-[16vh] mt-16 flex items-center justify-center text-zinc-500 font-medium tracking-tight transition-all duration-[4000ms]'>
