    ...
    <div style={{ height: '100vh' }} className="text-center text-white relative p-12">
     <div className="absolute top-2"> 
      ...
      <Canvas flat camera={{fov: 28}} style={{ height: '100%' }} className="bgbg-[#0C0C0C]">
        <OrbitControls 
          enableZoom={false}
          minPolarAngle={Math.PI/8} // 30 degrees minimum rotation
          maxPolarAngle={Math.PI - Math.PI/8} // 30 degrees from bottom
          minAzimuthAngle={-Math.PI/8} // -30 degrees horizontal rotation
          maxAzimuthAngle={Math.PI/8} // +30 degrees horizontal rotation
        />
        <ambientLight />
        <Component3d/>
        <EffectComposer>
