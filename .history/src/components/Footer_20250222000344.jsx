      ...
      <div className="py-[3vh] lg:flex lg:justify-between lg:items-center lg:pl-20">
        ...
        <div className="flex flex-col items-center lg:ml-12">
          ...
          <div className="flex gap-8 text-[5.5vw] lg:text-[1.5vw]">
            <motion.a
              className="relative text-white lg:p-8 lg:border-[1px] lg:border-[#2A2929] lg:overflow-hidden lg:bg-[#2A2929]"
            ...
            >
              ...
              <motion.span
                className="lg:absolute lg:-inset-1 lg:bg-[#FF2648] lg:transform"
            ...
            >
              ...
              <motion.span
                className="lg:absolute lg:-inset-1 lg:bg-blue-500 lg:transform"
                initial={{ translateY: '100%' }}
                animate={{ translateY: '0' }}
                transition={{ duration: 0.3 }}
              ></motion.span>
            ...
            >
              ...
              <motion.span
                className="lg:absolute lg:-inset-1 lg:bg-[#6228d7] lg:transform"
                initial={{ translateY: '100%' }}
                animate={{ translateY: '0' }}
                transition={{ duration: 0.3 }}
              ></motion.span>
