...
const ThreeScene = () => {
  ...
  const handleMouseEnter = (colorValue) => {
    gsap.to(materialRef.current.uniforms.uColorChange, { value: colorValue, duration: 0.5 });
  };

  const handleMouseLeave = () => {
    gsap.to(materialRef.current.uniforms.uColorChange, { value: 0, duration: 0.5 });
  };
    ...
    <div className="w-full">
      <div className="landing w-screen relative flex flex-col">
        <div className="flex items-center justify-center">
          <h2
            ref={h2Ref}
            className="text-[2.5vw] z-[3] font-bold text-zinc-800 text-center absolute cursor-pointer pt-4"
          >
            <span onMouseEnter={() => handleMouseEnter(1)} onMouseLeave={handleMouseLeave}>
              WE CREATE.
            </span>{" "}
            <span onMouseEnter={() => handleMouseEnter(2)} onMouseLeave={handleMouseLeave}>
              CELEBRATE.
            </span>
          </h2>
          <h1 ref={h1Ref} className="text-[5.5vh] text-center absolute font-bold pt-[62vh] z-[3]">
