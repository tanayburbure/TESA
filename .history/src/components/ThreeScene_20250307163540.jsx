...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    sphereRef.current.position.set(0, 0.55, 0);
    sceneRef.current.add(sphereRef.current);
    
    cameraRef.current.position.z = 2.7; // Moved slightly forward to maintain the same visual size
  ...
  return (
    <div className="w-full">
      <div className="landing w-screen relative flex flex-col">
        ...
        <div ref={canvasRef} className="absolute z-[2]"></div>
      </div>
      <div className="mt-[50vh] z-[-4]">
      <PageTransition/>
      </div>
    </div>
  );
