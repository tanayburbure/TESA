    ...
    <div>
      <div ref={containerRef} style={{ height: '140vh' }} className="text-center text-white pt-[30vh] bg-[#EBEBEB] relative">
        ...
        <div className="absolute "> 
          <h1 className="text-[5.5vw] text-zinc-600 font-bold font-[font4] transition-all duration-300">Event Highlights</h1>
          <p className="px-20 text-[2.6vh] text-zinc-100 mb-20 -mt-12 font-[font3] transition-all duration-300">Experience the perfect blend of Culture, Technology, Athleticism at our captivating events, where innovation meets tradition in a spectacular showcase of talent and passion. Join us on an exhilarating journey through the realms of Culture, Technology, and Sports.</p>
        </div>
