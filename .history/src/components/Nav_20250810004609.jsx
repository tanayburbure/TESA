...
function Nav() {
  ...
  useEffect(() => {
    gsap.to(titleRef.current, {
      ...
      duration: 0.8,
      ease: 'power2.in',
      delay: 2, // Note: delay won't work with a scrub animation
      force3D: true, // Prevents blurring on transform
      scrollTrigger: {
        trigger: titleRef.current,
        start: 'top -50%', 
        end: 'top 10%', 
        scrub: 3, // Links animation to scroll, making toggleActions redundant
      },
    });
  }, []);
