    ...
    <div className="wrapper relative bg-black overflow-x-hidden">
      <div className="page5">
        <div ref={sectionRef} id="page5" className="relative h-screen w-full overflow-hidden">
          ...
          >
            <div className="border-t border-white h-[0.5px] w-full absolute left-[8vw] top-[41.5vh]"></div>
            <div className="border-t border-white h-[0.5px] w-full absolute left-[8vw] top-[58vh]"></div>
          <img className="h-[100vh] w-[159vw] z-[999999] absolute left-0 top-0" src="public\team.png" alt="" />
            {[
