...
function Nav() {
  ...
  useEffect(() => {
    gsap.to(titleRef.current, {
      ...
      scrollTrigger: {
        ...
        start: 'top 80%', // Adjusted trigger start
        end: 'top 30%',  // Adjusted end for smooth effect
        scrub: 1,
  ...
  return (
    <div className='flex fixed  relative justify-between items-center pt-8 px-8'>
      <div className='flex items-center px-3 z-[9999] py-[2.2vh]'>
        <img className='absolute w-14 mt-2 mr-2 select-none' src='/images/tesahalf.png' alt='TESA Logo' />
        <h2 ref={titleRef} className='absolute text-zinc-200 pl-16 text-2xl top-8 left-20'>
          TESA 2.0
        </h2>
      </div>

      <div>
        <div className='group fixed z-[9999]'>
