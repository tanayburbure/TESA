...
const Team = () => {
    ...
    return (
      <div className="wrapper overflow-x-hidden">
        <div
          className="flex w-[300vw] h-[70vh]"
          ref={scrollContainerRef}
        >
          {/* Page 1 */}
          <div className="w-screen h-[70vh] bg-red-500 flex items-center justify-center">
            <h1 className="text-white text-4xl">Page 1</h1>
          </div>
          {/* Page 2 */}
          <div className="w-screen h-[70vh] bg-green-500 flex items-center justify-center">
            <h1 className="text-white text-4xl">Page 2</h1>
          </div>
          {/* Page 3 */}
          <div className="w-screen h-[70vh] bg-blue-500 flex items-center justify-center">
