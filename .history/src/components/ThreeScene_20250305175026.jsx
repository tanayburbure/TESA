...
const ThreeScene = () => {
  ...
  const [isH2Visible, setIsH2Visible] = useState(true); // Track visibility of h2
  ...
  useEffect(() => {
    ...
    gsap.to(h2Ref.current, {
      opacity: 0,
      onComplete: () => setIsH2Visible(false), // Set visibility to false after fade out
      scrollTrigger: {
    ...
    <div className="w-full">
      <div className="landing w-screen relative flex flex-col">
        <div className="flex items-center justify-center">
          {isH2Visible && ( // Only render h2 if it's visible
            <motion.h2
              ref={h2Ref}
