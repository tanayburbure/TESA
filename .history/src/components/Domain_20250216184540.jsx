      ...
      <div className='flex items-center justify-center gap-1'>
        {domains.map((text, index) => (
          <div
            ...
            style={{
              width: hoveredIndex === null ? '70px' : hoveredIndex === index ? '84px' : '63px',
              height: hoveredIndex === null ? '65px' : hoveredIndex === index ? '80px' : '50px',
              transform: hoveredIndex === index ? 'scale(1.2)' : 'scale(1.1)',
