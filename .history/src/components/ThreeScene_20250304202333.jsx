...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    // ScrollTrigger to dismantle h2 after scrolling and make it reversible
    ScrollTrigger.create({
      trigger: h2Ref.current,
      start: "top 80%",
      end: "top 50%",
      onEnter: () => {
        gsap.to(h2Ref.current, { opacity: 0, duration: 1 });
      },
      onLeaveBack: () => {
        gsap.to(h2Ref.current, { opacity: 1, duration: 1 });
      },
      scrub: true, // Make the animation reversible
    });
