...
import LocomotiveScroll from "locomotive-scroll"; // Ensure this is correctly imported
...
const ThreeCanvas = () => {
  ...
  useEffect(() => {
    ...
    const locomotiveScroll = new LocomotiveScroll({
      el: document.querySelector(".scroll-container"), // Ensure to provide a valid element
      smooth: true,
    });
