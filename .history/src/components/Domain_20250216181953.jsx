      ...
      <div className='flex items-center justify-center' style={{ gap: '10px' }}>
        {domains.map((text, index) => (
          <div
            ...
            style={{
              width: hoveredIndex === null ? '100px' : hoveredIndex === index ? '120px' : '90px', // Adjusted width to keep it subtle
              height: hoveredIndex === null ? '80px' : hoveredIndex === index ? '96px' : '72px',
              transform: hoveredIndex === index ? 'scale(1.2)' : 'scale(1)', // Reduced scale effect
