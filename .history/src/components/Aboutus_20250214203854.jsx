...
function Aboutus() {
  return (
    <div className='text-white h-[100vh] px-24 pt-32'>
        <h1 className='text-[6vh] font-bold'>WHO WE ARE</h1>
        <h3 className='text-[2.5vh]'>We are Telecom Engineers Student Association has been carrying on its legacy for many years.</h3>
        <br />
