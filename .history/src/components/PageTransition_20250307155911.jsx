...
const ScrollBgTransition = () => {
  ...
  return (
    <div ref={containerRef} className="relative h-[100vh] flex items-center justify-center bg-[#EBEBEB]">
      {/* Black Overlay with Smooth Strengthening Effect */}
      <div
        ref={overlayRef}
        className="absolute bottom-0 left-0 w-full h-0 bg-black"
        style={{
          maskImage: "linear-gradient(to top, rgba(255,255,255,1) 0%, rgba(0,0,0,1) 50%)",
          WebkitMaskImage: "linear-gradient(to top, rgba(255,255,255,1) 0%, rgba(0,0,0,1) 50%)",
        }}
      ></div>
