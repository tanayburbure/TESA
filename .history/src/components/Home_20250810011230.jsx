...
const Spotlight = ({
  ...
  return (
    <>
      ...
      <svg
        className={cn(
          /* FIXED: Reduced width back to reasonable size and added overflow-hidden to parent */
          "animate-spotlight pointer-events-none absolute h-[110%] w-[300%] lg:w-[200%] opacity-0",
          className
        )}
      ...
      >
        <g filter="url(#filter)">
          <ellipse
            cx="1924.71"
            cy="273.501"
            /* KEPT: 3x wider ellipse but with better container management */
            rx="5774.13"
            ry="273.501"
...
const Home = () => {
  return (
    /* FIXED: Added overflow-hidden to prevent horizontal scroll */
    <div className="h-[80vh] z-1 overflow-hidden">
      <Spotlight 
