...
function Components3d() {
  ...
  return (
    <div>
      <div ref={containerRef} style={{ height: '140vh' }} className="text-center text-white pt-[30vh] relative">
        <div 
          ref={overlayRef}
          className="absolute bottom-0 left-0 w-full h-96 pt-12"
          style={{
            background: '#18181B',
            maskImage: 'linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 60%, rgba(0,0,0,0.4) 70%, rgba(0,0,0,0) 100%)',
            WebkitMaskImage: 'linear-gradient(to top, rgba(0,0,0,1) 0%, rgba(0,0,0,0.8) 60%, rgba(0,0,0,0.4) 70%, rgba(0,0,0,0) 100%)',
