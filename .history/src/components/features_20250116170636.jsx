...
function Highlights() {
    return (
        <div className='flex flex-col h-[70vh] items-center justify-start text-white'>
            <h1 className='text-[3vw]'>Features of our website</h1>
            <h3 className='text-center px-20'>We have implemented highly beneficial features on our website, designed to enhance student experience and utility.</h3>
            <div className="flex gap-4 mt-8">
                <div className="h-[12vw] w-[18vw] pt-12 px-4 bg-zinc-800 rounded-lg text-center">
                    <img src="" alt="" />
                    <h2>Interveiw Exp</h2>
                ...
                <div className="h-[12vw] w-[18vw] px-4 bg-zinc-800 rounded-lg text-center">
                    <img src="" alt="" />
                    <h2>Interveiw Exp</h2>
