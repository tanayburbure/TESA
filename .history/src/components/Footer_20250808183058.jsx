      ...
      <div className="py-[3vh] lg:flex lg:justify-between lg:items-center lg:pl-12">
        ...
        <div className="flex flex-col items-center lg:ml-12">
          ...
          <div className="flex gap-8 text-[#EBEBEB] text-[5.5vw] lg:text-[1.5vw]">
            <a
              className="relative  lg:p-8  lg:overflow-hidden lg:hover:scale-110 lg:rounded-full lg:bg-[#3B6654] transition-all duration-300 group"
              href="https://www.instagram.com/your-profile"
              target="_blank"
              rel="noopener noreferrer"
            >
              <IoLogoInstagram className="relative z-10" />
              <span className="lg:absolute lg:-inset-1 lg:bg-[#3B6654] lg:transform lg:translate-y-full lg:group-hover:translate-y-0 lg:transition-transform lg:duration-300 lg:z-0"></span>
            </a>
            <a
