    ...
    const initAnimation = () => {
      ctx = gsap.context(() => {
        if (sectionRef.current && imageContainerRef.current && titleRef.current && blackLinesRef.current) {
          // Hide black lines initially
          gsap.set(blackLinesRef.current.children, { opacity: 0 });
          ...
          gsap.fromTo(titleRef.current, 
            ...
            },
            {
              ...
              scrollTrigger: {
                ...
                onComplete: () => {
                  // Animate black lines after title animation completes
                  gsap.to(blackLinesRef.current.children, {
                    opacity: 1,
                    duration: 0.8,
                    ease: "power2.out",
                    stagger: 0.2
