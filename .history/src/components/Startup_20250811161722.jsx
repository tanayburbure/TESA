  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bg-red-200 top-15 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 h-[65%] flex items-end group-hover/product:from-black/90">
