...
function Components3d() {
  ...
  return (
    <div className="">
      <div ref={containerRef} style={{ height: '125vh' }} className="text-center pt-[15vh]  relative">
        <div 
          ref={overlayRef}
        ...
        <div className="absolute "> 
          <h1 className="text-[8vh] font-[font4] tracking-wide font-semibold">Event Highlights</h1>
          <p className="px-20 text-[2.4vh] mb-20 -mt-2 font-[font3]">Experience the perfect blend of Culture, Technology, Athleticism at our captivating events, where innovation meets tradition in a spectacular showcase of talent and passion. Join us on an exhilarating journey through the realms of Culture, Technology, and Sports.</p>
        </div>
        <Canvas className="no-draw" flat camera={{ fov: 28 }} style={{ height: '100%' }}>
          <OrbitControls 
            enableZoom={false}
            enableRotate={true}
