          ...
          <div className="flex gap-8 text-[5.5vw] lg:text-[1.5vw]">
            {[{
              ...
              <motion.a
                ...
                className="relative text-white lg:p-8 lg:border-[1px] lg:border-[#2A2929] lg:overflow-hidden lg:rounded-full lg:bg-[#2A2929]"
                whileHover={{ scale: 1.1 }}
                transition={{ duration: 0.3 }}
              >
                {icon}
      ...
      <div>
        ...
        <div className="flex items-center justify-between font-[font1] text-[2.1vw] lg:text-[1.3vw] text-zinc-600 lg:flex-row lg:justify-between lg:items-center lg:px-16 px-2">
          ...
          <div className='text-center'>
            ...
            <motion.a 
              className="text-zinc-500 text-[1.2vh] flex items-center justify-center lg:text-[1.3vw] text-sm lg:text-[2.2vh] lg:text-zinc-500"
              whileHover={{ scale: 1.1 }}
              transition={{ duration: 0.3 }}
            >
