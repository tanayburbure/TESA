...
import LocomotiveScroll from "locomotive-scroll"; // Correct casing for the import
...
const ThreeCanvas = () => {
  ...
  useEffect(() => {
    ...
    const locomotiveScrollInstance = new LocomotiveScroll(); // Renamed to avoid confusion with the component
    ...
    return () => {
      renderer.dispose();
      locomotiveScrollInstance.destroy(); // Use the renamed instance
    };
  }, []);
