      ...
      if (sectionRef.current && imageContainerRef.current) {
        ...
        const tl = gsap.timeline({
          scrollTrigger: {
            ...
            onEnter: () => {
              // Pause scroll until animation is complete
              ScrollTrigger.getById("scrollPause").disable();
            },
            onLeaveBack: () => {
              // Enable scrolling back after animation completes
              ScrollTrigger.getById("scrollPause").enable();
            },
          },
        });
