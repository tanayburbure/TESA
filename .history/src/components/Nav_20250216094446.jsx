  ...
  useEffect(() => {
    gsap.to(titleRef.current, {
      ...
      scrollTrigger: {
        ...
        start: 'top 80%', // Starts when the title enters 80% of the viewport
        end: 'top 20%', // Ends when the title reaches 20% of the viewport
        scrub: 1,
        toggleActions: 'play none none reverse',
        markers: true, // Keep for debugging, remove after testing
      },
    });
  }, []);
