                ...
                >
                    {products.map((product, index) => (
                        <ProductCard
                            product={product}
                            key={product.title}
                            // ✅ CORRECTED: Using relative positioning to prevent conflicts with the animation.
                            style={index === 0 ? { position: 'relative', left: '-85vh' } : {}}
                        />
                    ))}
                </motion.div>
            </motion.div>
...
// Modified ProductCard to accept and apply a 'style' prop
