  ...
  return (
    <div className="h-[70vh] lg:h-[50vh] md:h-[73vh] overflow-hidden">
      ...
      <div className=" py-[3vh] lg:flex lg:justify-between lg:items-center lg:pl-20">
        <div className="py-[5vh] flex flex-col items-center text-zinc-400">
          <img
            className="h-[20vw] lg:h-[10vw] mb-2 select-none transition-transform duration-300"
            src="public\images\tesalogo.png"
            alt="TESA Logo"
          />
        ...
        <div className="flex flex-col items-center lg:ml-12">
          <h2 className="text-zinc-400 text-[3vh] text-center mb-8 lg:text-[4vh]">
            SOCIALS
          </h2>
        ...
        <div className="flex flex-col items-center mt-12 lg:mt-0 lg:pr-16 lg:items-start">
          <h2 className="text-zinc-400 text-[3vh] lg:text-[4vh] mb-7 lg:pl-16">
            ADDRESS
          </h2>
          <div className="text-zinc-400 flex text-[2.4vh] gap-[8px] mb-3">
          ...
          <div className="text-zinc-400 flex items-center gap-[13px] lg:pl-[0vh] md:pl-[5vh] mr-[23vw] lg:mr-0">
      ...
      <div>
        ...
        <div className="flex items-center justify-between text-[2.1vw] lg:text-[1.3vw] text-zinc-600 lg:flex-row lg:justify-between lg:items-center lg:px-16 px-2">
