  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div className="flex flex-row-reverse space-x-reverse space-x-20 mb-20" style={{ transform: 'translateX(-20vh)' }}>
        ...
        <motion.div className="flex flex-row mb-20 space-x-20" style={{ transform: 'translateX(20vh)' }}>
        ...
        <motion.div className="flex flex-row-reverse space-x-reverse space-x-20" style={{ transform: 'translateX(-200vh)' }}>
