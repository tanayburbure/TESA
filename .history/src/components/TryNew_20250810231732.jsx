...
export default function HamburgerMenu() {
  ...
  return (
   <div className=' fixed top-6 right-6 z-[99999]'>
    ...
    >
      {/* Fixed container for lines - counteract parent scale */}
      <motion.div 
        className="absolute top-8 right-8 w-0 h-0 flex justify-center items-center"
        animate={{
          scale: isHovered ? 1 / 1.05 : 1  // Counteract the parent's 1.05 scale
        }}
        transition={{ duration: 0.15 }}
      >
