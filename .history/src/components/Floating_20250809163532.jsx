...
const Floating = () => {
  ...
  const [logos] = useState([
    ...
    { id: 1, alt: 'TypeScript', imageUrl: './vscode.png', top: 20, left: 25, filterColor: '#007ACC', animationDelay: '0s' },
    { id: 2, alt: 'R', imageUrl: './chip.png', top: 30, left: 80, filterColor: '#276DC3', animationDelay: '0.5s' },
    { id: 3, alt: 'Rust', imageUrl: './radio.png', top: 75, left: 20, filterColor: '#E4482B', animationDelay: '1s' },
