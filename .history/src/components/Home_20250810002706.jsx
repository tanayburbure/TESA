...
// Three.js Scene Component - SOLUTION 2
const ThreeScene = () => {
...
// Main Component - SOLUTION 2 (RESTRUCTURED)
const Home = () => {
  const blinkRef = useRef(null);
  const h1Ref = useRef(null);

  useEffect(() => {
    // GSAP Animations moved to main component
  ...
  return (
    <div className="w-full">
      ...
      <div className="h-[80vh] relative z-[5]">
        <Spotlight 
      ...
      {/* Second Section - RESTRUCTURED Three.js Scene */}
      <div className="landing w-screen relative flex flex-col min-h-screen">
        {/* Background layer - Three.js scene */}
        ...
        <div className="relative z-[3] flex items-center justify-center h-full">
          <h1
            ref={h1Ref}
            className="text-[7vh] font-[font4] text-center font-semibold tracking-tight pt-[65vh] text-white"
          >
