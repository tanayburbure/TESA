...
const Team = () => {
  ...
  const renderedTeamImages = useMemo(() => {
    return teamImages.map((image, index) => (
      <div
        key={index}
        className={`team-image absolute z-[9999999] bg-blend-multiply
 overflow-hidden ${image.position}`}
        style={{
  ...
  return (
    <div className="wrapper relative  overflow-hidden">
      <div ref={sectionRef} className="relative h-screen w-full overflow-hidden">
        ...
        >
          <div className="border-t border-[#313131] h-[0.8px] w-full absolute left-[8vw] top-[41vh]"></div>
