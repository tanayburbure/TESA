  ...
  return (
    <div className='h-[28vw] mt-20'>
      <div className='flex gap-4 items-center justify-center'>
        <img 
          className='h-16 w-24 rounded grayscale-[100%] transition-transform duration-300 ease-in-out hover:grayscale-0 hover:scale-120 cursor-pointer hover:scale-120'
          src="src/images/socialbg.jpg"
          alt=""
          onMouseEnter={() => handleMouseEnter("TECHNICAL")}
          onMouseLeave={handleMouseLeave} />
        <img
          className='h-16 w-24 rounded grayscale-[100%] transition-transform duration-300 ease-in-out hover:grayscale-0 hover:scale-120 cursor-pointer'
          src="src/images/socialbg.jpg"
          alt=""
