    ...
    <div className="h-[75vh] lg:h-[50vh] md:h-[73vh] overflow-hidden">
      ...
      <div>
        ...
        <div className="flex items-center justify-between font-[font1] text-[2.1vw] lg:text-[1.3vw] text-zinc-600 lg:flex-row lg:justify-between lg:items-center lg:px-16 px-2">
          <h3 className="text-center text-[2.4vh] lg:text-left font-[font-1]">All Rights Reserved © 2025</h3>
          <div className="text-center">
            <h3 className='text-[2.4vh]'>Designed & Developed by</h3>
            <a className="relative text-zinc-500 text-[1.2vh] flex items-center pl-2 justify-center  lg:text-[1.3vw] text-sm lg:text-[2.2vh] lg:text-zinc-700 group cursor-pointer">
