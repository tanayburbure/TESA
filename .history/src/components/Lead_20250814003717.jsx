        ...
        >
            ...
            <div ref={sectionRef} className="relative h-screen w-full overflow-hidden z-10">
                <motion.div
                    ...
                    // CARD POSITIONING: Adjust justify-center to change horizontal alignment
                    // Options: justify-start, justify-center, justify-end
                    className="flex justify-center h-full items-center"
                >
                    <div
                        ref={cardsContainerRef}
                        // CARD CONTAINER POSITIONING: Adjust these values to move cards left/right
                        // pl-[10vw] = padding-left 10% viewport width
                        // Decrease value (e.g., pl-[5vw]) to move cards left
                        // Increase value (e.g., pl-[20vw]) to move cards right
                        // You can also use pr-[Xvw] for padding-right or ml-[Xvw] for margin-left
                        className="flex space-x-20 pl-[270vw]"
                        style={{ 
                            width: "fit-content",
