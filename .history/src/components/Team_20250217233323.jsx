      ...
      <div className="page5">
        <div ref={sectionRef} id="page5" className="relative h-screen w-full overflow-hidden">
          ...
          <div
            ...
            className="mt-[9vh] w-[300%] h-[60%] gap-[2vw] pl-[90vw] relative flex justify-evenly items-center"
          >
          <img className="absolute h-[100vh] w-[120vw] absolute left-0" src="public\team.png" alt="" />
            {[
