  ...
  return (
    <div className='fixed  w-screen pt-16 px-8 z-[9999]'>
      ...
      <div className='fixed top-8 right-8 group'>
        ...
        <div className='fixed no-draw top-0 right-0 w-0 h-screen bg-[#2A2929] p-4 opacity-0 pointer-events-none transform translate-x-full transition-all duration-500 group-hover:w-1/2 group-hover:opacity-100 group-hover:translate-x-0 group-hover:pointer-events-auto'>
