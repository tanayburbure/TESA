...
const HeroParallax = ({ products }) => {
    ...
    // Instead of marginLeft "450vh", we shift the start position here:
    const translateX = useSpring(
        // Change first number here → was 0, now a positive offset so first card starts at the left
        useTransform(scrollYProgress, [0, 0.8, 1], [2000, -1000, -100]),
        springConfig
    );
    ...
    const translateY = useSpring(
        useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [-600, 100, 400, 5000]),
        springConfig
    );
