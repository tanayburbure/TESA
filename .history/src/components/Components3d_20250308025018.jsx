    ...
    <div>
      <div ref={containerRef} style={{ height: '140vh' }} className="text-center text-white pt-[30vh] bg-[#EBEBEB] relative">
        <div 
          ...
          style={{
            background: '#18181B',
            clipPath: 'polygon(0% 100%, 100% 100%, 100% 20%, 95% 25%, 90% 15%, 85% 30%, 80% 10%, 75% 35%, 70% 15%, 65% 25%, 60% 5%, 55% 30%, 50% 10%, 45% 35%, 40% 15%, 35% 25%, 30% 5%, 25% 30%, 20% 10%, 15% 25%, 10% 15%, 5% 25%, 0% 20%)',
        ...
        <style>
          {`
            @keyframes waveEffect {
              ...
              50% {
                clipPath: polygon(0% 100%, 100% 100%, 100% 15%, 95% 30%, 90% 10%, 85% 25%, 80% 15%, 75% 30%, 70% 10%, 65% 30%, 60% 10%, 55% 25%, 50% 15%, 45% 30%, 40% 10%, 35% 30%, 30% 10%, 25% 25%, 20% 15%, 15% 30%, 10% 10%, 5% 30%, 0% 15%);
              }
            }
          `}
        </style>
