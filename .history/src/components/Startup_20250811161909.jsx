...
const ProductCard = ({ product, translate }) => {
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product bg-zinc-800 h-[30rem] w-[30rem] relative shrink-0"
    >
      <a
        href={product.link}
      ...
      >
        ...
        <div className="absolute  top-1 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 h-[65%] flex items-end group-hover/product:from-black/90">
