    ...
    <div className='h-[100vh] bg-green-200 relative flex flex-col  items-center justify-center'>
      ...
      <div className='absolute px-10'>
        ...
        <div className='flex justify-between mt-20'>
          ...
          <p ref={paragraphRef} className='w-[60%] text-[2.7vh] pr-8 tracking-tight leading-[3.5vh] text-zinc-200'>The Telecom Engineers Student Association (TESA) has proudly upheld its legacy for many years. <br />
