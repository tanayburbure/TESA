...
export const Thoughts = ({
  ...
  return (
    <div className="mx-auto h-[80vh] max-w-sm px-4 py-16 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img
                    ...
                    height={500}
                    draggable={false}
                    className="h-full w-full rounded-3xl object-cover object-center border-1 border-grey-500 shadow-lg"
                  />
