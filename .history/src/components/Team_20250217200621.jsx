    ...
    <div className="wrapper relative overflow-x-hidden">
      <div className="page5">
        <div ref={sectionRef} id="page5" className="relative h-screen w-full overflow-hidden">
          <h1 className="text-[#103289] text-[3.7vw] leading-[4vw] tracking-[-0.2vh] absolute top-[30%] font-[font1] pt-[8vh] pl-[5vw]">
            OUR CORE TEAM
          </h1>
          {/* Only images move */}
          <div
            ...
            className="mt-5 w-[230%] h-[60%] mt-[-1.5vw] gap-[2vw] pl-[15vw] relative flex justify-evenly items-center"
          >
            {[
