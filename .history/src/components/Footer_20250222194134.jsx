      ...
      <div>
        ...
        <div className="flex items-center justify-between font-[font1] text-[2.1vw] lg:text-[1.3vw] text-zinc-600 lg:flex-row lg:justify-between lg:items-center lg:px-16 px-2">
          ...
          <div className="text-center">
            ...
            <a className="relative text-zinc-500 text-[1.2vh] flex items-center justify-center lg:text-[1.3vw] text-sm lg:text-[2.2vh] lg:text-zinc-500 group">
  <span className="relative">
    Tanay Burbure
    <span className="absolute left-1/2 bottom-0 h-[1px] w-0 bg-zinc-500 transition-all duration-300 group-hover:left-0"></span>
    <span className="absolute left-1/2 bottom-0 h-[1px] w-full bg-zinc-500 transform scale-x-0 transition-transform duration-300 origin-center group-hover:scale-x-100"></span>
  </span>
