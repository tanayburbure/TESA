...
function Aboutus() {
  ...
  {/* Sliding background */}
  <span className="absolute top-[-60%] left-[-15%] h-[300%] w-[300%] bg-yellow-400 rounded-full -translate-x-full rotate-[10deg] origin-top-left transition-transform duration-200 ease-out group-hover:translate-x-0 z-[-1]"></span>
  Check Membership
</button>
