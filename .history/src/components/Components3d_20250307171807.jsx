...
function Components3d() {
  ...
  return (
    <div>
      <div ref={containerRef} style={{ height: '150vh' }} className="text-center text-white relative">
        <div 
          ref={overlayRef}
          ...
          style={{
            ...
            WebkitMaskImage: 'linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 35%)',
