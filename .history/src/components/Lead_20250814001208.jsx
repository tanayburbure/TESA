...
export default function Lead() {
    ...
    // Framer Motion scroll effects (coming from top)
    ...
    return (
        <div
            ref={sectionRef}
            className="h-screen w-full overflow-hidden relative select-none py-40"
        >
            <Header />
            <motion.div
                style={{
...
// ---------------------------
const Header = () => (
    <div className="max-w-7xl z-[1] absolute top-10 left-1/2 -translate-x-1/2 px-4">
...
const ProductCard = ({ product }) => (
    <motion.div
        whileHover={{ y: -20 }}
        className="group/product no-draw h-[29rem] w-[32rem] relative shrink-0 bg-zinc-900 mr-[2rem]"
        style={{
