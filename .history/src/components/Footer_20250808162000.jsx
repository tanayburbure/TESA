      ...
      <div>
        ...
        <div className="flex items-center justify-between font-[font1] text-[2.1vw] lg:text-[1.3vw] text-zinc-600 lg:flex-row lg:justify-between lg:items-center lg:px-16 px-2">
          ...
          <div className="text-center">
            ...
            <a className="relative text-zinc-500 text-[1.2vh] flex items-center pl-2 justify-center  lg:text-[1.3vw] text-sm lg:text-[2vh] lg:text-zinc-700 group cursor-pointer">
              ...
              <GoArrowUpRight className=" text-2xl opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
            </a>
