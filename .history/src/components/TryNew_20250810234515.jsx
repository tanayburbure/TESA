...
export default function HamburgerMenu() {
  ...
  return (
    <div className='fixed top-6 right-6 z-[99999]'>
      <motion.div
        className="cursor-pointer bg-[#4A9782] rounded-lg relative"
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        animate={{
          width: EXPANDED_WIDTH,   // Always expanded
          height: EXPANDED_HEIGHT  // Always expanded
        }}
        whileTap={{ scale: 0.95 }}
        transition={{
          duration: 0.15,
