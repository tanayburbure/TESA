...
const Team = () => {
  ...
  return (
    <div className="wrapper relative bg-black overflow-x-hidden">
      <div className="page5">
        <div ref={sectionRef} id="page5" className="relative h-screen w-full flex items-center  overflow-hidden">
              <h1 className="text-[#103289] text-[11vw] font-medium tracking-[-1vh] absolute font-[font1] pl-[14vw]">
                OUR CORE TEAM
              </h1>
          {/* Only images move */}
          <div
