...
function PageTransition({
  ...
  return (
    ...
    >
      ...
      <div className="bg-black absolute flex-none inset-[2px] rounded-[100px]" style={{ zIndex: 1 }} />
    </Tag>
  );
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 flex flex-col items-center justify-center p-8 space-y-8">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-white mb-4">HoverBorderGradient Component</h1>
