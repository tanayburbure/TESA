  ...
  return (
    <div id="page5" className="relative h-[130vh] w-full bg-white overflow-hidden">
      ...
      <div id="Contain" className="mt-[5%] w-[230%] h-[60%] gap-[10vw] pl-[15vw] relative flex justify-evenly items-center">
        {[
          { title: "Artificial Intelligence", image: "public\images\Madhavi Shinde_.jpg" },
          { title: "Laptop", image: "public\images\Madhavi Shinde_.jpg" },
          { title: "Iot", image: "public\images\Madhavi Shinde_.jpg" },
          { title: "Mobile", image: "public\images\Madhavi Shinde_.jpg" },
          { title: "Automotive", image: "public\images\Madhavi Shinde_.jpg" },
          { title: "Audio", image: "public\images\Madhavi Shinde_.jpg" },
          { title: "Wifi Network", image: "public\images\Madhavi Shinde_.jpg" },
          { title: "XR/VR", image: "public\images\Madhavi Shinde_.jpg" },
        ].map((item, index) => (
