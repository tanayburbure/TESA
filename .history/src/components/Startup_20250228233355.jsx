...
function Startup() {
    ...
    const profile = ["./startup/aaditya.jpg","./startup/Searchin.png","./startup/Mayank.png","./Shraddha.png","./startup/sassyDesigns.png","./startup/adarshgaurav.jpg"]
                    ...
                    <div key={index} className='bg-zinc-800 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300'>
                        ...
                        <div className='p-6'>
                            ...
                            <div className='flex items-center gap-3 mb-4'>
                                ...
                                />
                                <h3 className='text-md font-medium text-zinc-300'>{Name[index]}</h3>
                            </div>
                            <p className='text-zinc-400 text-sm mb-6 line-clamp-4'>
                                {Description[index]}
                            </p>
                            <div className='flex justify-between items-center'>
                                <span className='text-zinc-300'>{Name[index]}</span>
                                <a
                                    href="#"
