...
function Features() {
    return (
        <div className='flex flex-col h-[92vh] items-center pt-24'>
            ...
            <h3 className='text-center text-[2.5vh] font-[font3] -mt-2'>Our website is equipped with highly impactful features, thoughtfully designed to enhance student experience and usability.</h3>
            <div className="Card flex gap-8 mt-24">
