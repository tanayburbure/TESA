    ...
    <div className='h-[100vh] relative flex'>
      ...
      <div className='absolute px-10 text-center flex flex-col items-center justify-center'>
        ...
        <div className='flex flex-col items-center mt-32'>
          ...
          <p ref={paragraphRef} className='w-[75%] text-[2.8vh] mt-12 tracking-tight leading-[3.7vh] text-zinc-400'>The Telecom Engineers Student Association (TESA) has proudly upheld its legacy for many years. <br />
        ...
        <div className='mt-16 flex gap-16'>
          <button className="text-zinc-700 border border-zinc-400 px-6 py-3 rounded-full mx-2 hover:bg-zinc-700 transition-all hover:mix-blend-difference duration-300">
            Become a Member
          </button>
