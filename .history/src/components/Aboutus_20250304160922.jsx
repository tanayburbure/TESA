...
function Aboutus() {
  ...
  return (
    <div className='text-white h-[100vh] bg-green-200 relative flex flex-col px-20 items-center justify-center'>
      <ThreeScene />
      <div className='absolute'>
        <div className='flex justify-between mt-20'>
          <h1 className='text-[5.5vh] text-zinc-900 font-bold pt-2 pl-4'><span className='font-medium pr-4 mb-2' ref={blinkRef}>[</span> WE ARE </h1>
