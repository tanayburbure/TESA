...
function Thoughts() {
  return (
    <div className='h-[100vh] text-white bg-zinc-900'>
      ...
      <div className="max-w-sm mx-auto h-[63vh] mt-24">
        {studentThoughts.map((student, index) => (
          <div key={index} className="bg-[#2A2929] rounded-lg overflow-hidden shadow-lg m-4">
            <img
            ...
            <div className="px-5 py-4">
              ...
              <h3 className='text-[1.8vh] ml-1 text-zinc-400 font-semibold'>{student.course}</h3>
