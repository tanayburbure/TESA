  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 h-[65%] flex items-end group-hover/product:from-black/90">
