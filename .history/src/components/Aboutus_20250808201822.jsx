    ...
    <div className='h-[100vh] relative flex bg-[#EBEBEB]'>
      ...
      <div className='absolute px-10 text-center flex flex-col items-center justify-center'>
        ...
        <div className='mt-8 flex gap-16 z-[1]'>
          <button className="relative overflow-hidden border-2 border-zinc-700 font-[font4] px-4 py-2 pt-[12px] rounded-full mx-2 text-zinc-700 transition-all duration-300 transform scale-100 hover:scale-105 hover:border-transparent hover:text-indigo-900 group">
            {/* Sliding background */}
            <span className="absolute top-[-85%] left-[-15%] h-[300%] w-[300%] bg-[#3B6654] rounded-full -translate-x-full rotate-[10deg] origin-top-left transition-transform duration-200 ease-out group-hover:translate-x-0 z-[-1]"></span>
            Become a Member
          </button>
          <button className="relative overflow-hidden font-[font4] border-2 border-zinc-700 px-4 pt-[2px] rounded-full mx-2 text-zinc-700 transition-all duration-300 transform scale-100 hover:scale-105 hover:border-transparent hover:text-indigo-900 group">
            {/* Sliding background */}
            <span className="absolute top-[-70%] left-[-15%] h-[300%] w-[300%] bg-[#3B6654] rounded-full -translate-x-full rotate-[10deg] origin-top-left transition-transform duration-200 ease-out group-hover:translate-x-0 z-[-1]"></span>
            Check Membership
          </button>
