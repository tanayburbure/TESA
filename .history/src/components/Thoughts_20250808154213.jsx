...
export const Thoughts = ({
  ...
  height={500}
  draggable={false}
  className="h-full w-full rounded-3xl object-cover object-center border-2 border-green-200 shadow-lg"
/>
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            ...
            <motion.p className="mt-8 text-lg font-semibold text-gray-600 leading-6 font-[font3]">
