...
const Floating = () => {
  ...
  const [logos] = useState([
    ...
    { id: 2, alt: 'Chip', imageUrl: './chip.png', top: 10, left: 67, filterColor: '#276DC3', animationDelay: '0.5s' },
    { id: 3, alt: 'radio', imageUrl: './radio.png', top: 80, left: 20, filterColor: '#E4482B', animationDelay: '1s' },
    { id: 4, alt: 'Python', imageUrl: './python.png', top: 55, left: 84, filterColor: '#F7931A', animationDelay: '1.5s' },
  ]);
