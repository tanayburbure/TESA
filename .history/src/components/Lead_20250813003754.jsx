...
const HeroParallax = ({ products }) => {
    ...
    // ✅ THE IMPROVEMENT:
    // Instead of using a large margin, we set the animation's starting value to a large
    // positive number (e.g., 2500). The animation now correctly handles the initial offset.
    // You can adjust the 2500 to get the perfect starting position.
    const translateX = useSpring(
        useTransform(scrollYProgress, [0, 0.8, 1], [2500, -1200, -1200]),
        springConfig
    );
    ...
    return (
        ...
        >
            ...
            >
                {/* We removed the marginLeft from here, as it's no longer needed. */}
                <motion.div 
