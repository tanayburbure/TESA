    ...
    <div className="wrapper relative bg-black overflow-x-hidden">
      <div className="page5">
        <div ref={sectionRef} id="page5" className="relative h-screen w-full overflow-hidden">
          <div className="border-t-2 border-b-2 border-[#103289] absolute top-[32%]">
            <h1 className="text-[#103289] text-[11vw] font-medium leading-[4vw] tracking-[-1vh] absolute top-[32%] font-[font1] pt-[12vh] pl-[14vw]">
              OUR CORE TEAM
            </h1>
          </div>
          {/* Only images move */}
