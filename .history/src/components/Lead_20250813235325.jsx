...
// ---------------------------
// HeroParallax Section (GSAP Horizontal Scroll)
// ---------------------------
const HeroParallax = ({ products }) => {
    ...
    return (
        <section ref={containerRef} className="relative h-[100vh]">
            {/* Sticky viewport */}
            <div ref={sectionRef} className="sticky top-0 h-screen overflow-hidden flex flex-col [perspective:1000px] [transform-style:preserve-3d]">
                <Header />
