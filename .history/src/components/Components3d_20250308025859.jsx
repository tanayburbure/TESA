    ...
    <div>
      <div ref={containerRef} style={{ height: '140vh' }} className="text-center text-white pt-[30vh] bg-[#EBEBEB] relative">
        <div 
          ...
          style={{
            background: '#18181B',
            clipPath: 'polygon(0% 15%, 48% 0%, 100% 20%, 100% 100%, 0% 100%)',
            WebkitClipPath: 'polygon(0% 15%, 48% 0%, 100% 20%, 100% 100%, 0% 100%)',
            maskImage: 'linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.6) 40%, rgba(0,0,0,0.9) 70%, rgba(0,0,0,1) 100%)',
            WebkitMaskImage: 'linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, rgba(0,0,0,0.6) 40%, rgba(0,0,0,0.9) 70%, rgba(0,0,0,1) 100%)',
