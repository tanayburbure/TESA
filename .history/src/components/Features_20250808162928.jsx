...
function Features() {
    return (
        <div className='flex flex-col h-[90vh] items-center pt-24'>
            <h1 className='text-[7.5vh] font-[font4] tracking-wide font-semibold'>Features of our website</h1>
            <h3 className='text-center text-[2.5vh] font-[font3] mb-2'>Our website is equipped with highly impactful features, thoughtfully designed to enhance student experience and usability.</h3>
