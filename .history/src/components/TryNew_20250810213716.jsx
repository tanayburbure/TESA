...
export default function HamburgerMenu() {
  ...
  return (
   <div className=' fixed top-6 left-[94.2%] z-[99999]'>
     <motion.div
      className=" w-16 h-16 cursor-pointer flex flex-col justify-center items-center bg-[#4A9782] rounded-lg  transition-colors"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
      whileHover={{ scale: 1.2 }} // Increased from 1.05 to 1.2 for more noticeable size increase
      whileTap={{ scale: 0.95 }}
