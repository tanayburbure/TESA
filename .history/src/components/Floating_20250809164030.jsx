...
const Floating = () => {
  ...
  const [logos] = useState([
    ...
    { id: 2, alt: 'R', imageUrl: './chip.png', top: 10, left: 67, filterColor: '#276DC3', animationDelay: '0.5s' },
    { id: 3, alt: 'Rust', imageUrl: './radio.png', top: 85, left: 20, filterColor: '#E4482B', animationDelay: '1s' },
    { id: 4, alt: 'Bitcoin', imageUrl: './python.png', top: 60, left: 84, filterColor: '#F7931A', animationDelay: '1.5s' },
    { id: 5, alt: 'VS Code', imageUrl: './study.png', top: 70, left: 50, filterColor: '#007ACC', animationDelay: '2s' },
  ]);
