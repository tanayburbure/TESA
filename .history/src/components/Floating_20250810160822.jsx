...
const Floating = () => {
  ...
  const [logos] = useState([
    ...
    { id: 1, alt: 'Vscode', imageUrl: './vscode.png', top: 25, left: 28, filterColor: '#007ACC', animationDelay: '0s' },
    { id: 2, alt: 'Chip', imageUrl: './chip.png', top: 12, left: 63, filterColor: '#276DC3', animationDelay: '0.5s' },
    { id: 3, alt: 'radio', imageUrl: './radio.png', top: 70, left: 23, filterColor: '#E4482B', animationDelay: '1s' },
    { id: 4, alt: 'Python', imageUrl: './python.png', top: 75, left: 71, filterColor: '#F7931A', animationDelay: '1.5s' },
  ]);
  ...
  return (
    <div className="absolute select-none inset-0 z-[1] h-screen w-screen overflow-hidden font-inter">
