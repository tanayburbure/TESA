        ...
        >
          {isHovered && (
            <motion.ul
              ...
              className='space-y-6 text-zinc-800 text-5xl text-white pt-24 px-8'
            >
              <li className=' transition-transform duration-300'>Home</li>
              <li className=' transition-transform duration-300'>About Us</li>
              <li className='group'>
                <button
                ...
                <ul id='services-submenu' className='hidden space-y-4 text-4xl pl-4 pt-4'>
                  <li className=' transition-transform duration-300'>Technical</li>
                  <li className=' transition-transform duration-300'>SPORTS</li>
                  <li className=' transition-transform duration-300'>T & P</li>
                  <li className=' transition-transform duration-300'>Cultural</li>
                  <li className=' transition-transform duration-300'>Media</li>
                  <li className=' transition-transform duration-300'>Social</li>
                  <li className=' transition-transform duration-300'>Study Circle</li>
                  <li className=' transition-transform duration-300'>Editoral</li>
                </ul>
              </li>
              <li className=' transition-transform duration-300'>Interview Exp</li>
              <li className=' transition-transform duration-300'>Startup</li>
            </motion.ul>
          )}
        </motion.div>
