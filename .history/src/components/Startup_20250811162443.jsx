...
const ProductCard = ({ product, translate }) => {
  return (
    ...
    >
      <a
        href={product.link}
        className="block group-hover/product:shadow-2xl relative"
      >
        <img
      ...
      <div className="absolute bottom-4 left-4 p-4 rounded-xl group-hover/product:opacity-100 text-white w-full ">
        {/* Name and details where title used to be */}
        <div className="flex items-center mb-3">
          <img
            src={product.profile.imageUrl}
            alt={product.profile.name}
        ...
        {/* Description below name/details */}
