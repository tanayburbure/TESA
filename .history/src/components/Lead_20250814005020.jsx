            ...
            <div ref={sectionRef} className="relative h-screen w-full overflow-hidden z-10">
                ...
                >
                    <div
                        ...
                        // METHOD A: Use vw (viewport width) for horizontal spacing
                        // pl-[20vw] = 20% of screen width (more predictable)
                        // 
                        // METHOD B: Use fixed pixels for precise control
                        // pl-[300px] = exactly 300 pixels from left
                        //
                        // METHOD C: Use standard Tailwind classes
                        // pl-20 (80px), pl-24 (96px), pl-32 (128px)
                        //
                        // Current: Using 20vw (20% viewport width) - RECOMMENDED
                        className="flex space-x-20 pl-[30vw]"
                        style={{ 
                            width: "fit-content",
