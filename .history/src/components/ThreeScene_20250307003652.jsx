...
const ThreeScene = () => {
  ...
  return (
    <div className="w-full bg-zinc-800">
      <div className="landing w-screen bg-zinc-300 relative flex flex-col">
        <div className="flex items-center justify-center">
          <h2
            ref={h2Ref}
            className="text-[2.5vw] z-[99] bg-green-600 font-bold text-center absolute cursor-pointer pt-4"
          >
          ...
          <h1
            ref={h1Ref}
            className="text-[5.5vh] text-center absolute font-bold bg-blue-400 pt-[62vh] z-[3]"
          >
        ...
        <div ref={canvasRef} className="absolute bg-red-700"></div>
      </div>
    </div>
  );
};
