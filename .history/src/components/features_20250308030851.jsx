...
function Highlights() {
    return (
        <div className='flex flex-col mt-8 bg-zinc-900 h-[70vh] items-center justify-start text-white'>
            <h1 className='text-[3.8vw] font-[font4] tracking-lighter font-semibold'>Features of our website</h1>
            <h3 className='text-center'>Our website is equipped with highly impactful features, thoughtfully designed to enhance student experience and usability.</h3>
