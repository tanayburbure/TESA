...
const HeroParallax = ({ products }) => {
    ...
    // Extended translateX range so after 100% scroll inside section, cards keep moving horizontally
    const translateX = useSpring(
        useTransform(scrollYProgress, 
            [0, 0.8, 1, 1.5], 
            [2100, -1000, -2000, -3500] // <- after section ends, keep going left
        ),
        springConfig
    );
    ...
    return (
        <div
            ref={ref}
            className="h-[220vh] select-none py-40 overflow-hidden antialiased relative flex flex-col [perspective:1000px] [transform-style:preserve-3d]"
        >
            <Header />
