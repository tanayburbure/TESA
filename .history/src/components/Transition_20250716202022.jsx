        ...
        <div className="content mt-[20%]">
          <div className="container grid grid-cols-2 gap-8 px-12">
            <div className="image-container text-center">
              ...
              <img src="./team.png" alt="Image 1" className="w-full object-contain" />
            </div>
            <div className="image-container text-center">
              <h3 className="text-lg font-semibold mb-2">Qualcomm X Elite</h3>
              <img src="./team.png" alt="Image 2" className="w-full object-contain" />
            </div>
            <div className="image-container text-center">
              <h3 className="text-lg font-semibold mb-2">Robotics RB3 gen 2</h3>
              <img src="./team.png" alt="Image 3" className="w-full object-contain" />
            </div>
            <div className="image-container text-center">
              <h3 className="text-lg font-semibold mb-2">Qualcomm Cortex cpu</h3>
              <img src="./team.png" alt="Image 4" className="w-full object-contain" />
            </div>
          </div>
        </div>
      </div>
