...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      sphereRef.current.position.y = 1 - scrollY * 0.001; // Adjust the multiplier for speed
    };
  ...
  return (
    <div className="w-full">
      ...
      <h2 className="text-[2.5vw] font-bold text-zinc-800 text-center absolute cursor-pointer">WE CREATE. YOU CELEBRATE.</h2>
      <h1 className='text-[5.5vh] text-center absolute font-bold pt-2 '><span className='font-medium pr-4 mb-2' ref={blinkRef}>[</span> WE ARE </h1>
