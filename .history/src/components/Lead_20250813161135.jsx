...
const HeroParallax = ({ products }) => {
    ...
    // --- MODIFIED CODE ---
    // This new definition for `translateX` aligns its animation
    // with the pinned section of the scrollYProgress (from 0.2 to 0.8).
    const translateX = useSpring(
        useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [2100, 2100, -1000, -100]),
        springConfig
    );
