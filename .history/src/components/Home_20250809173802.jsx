    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="h-screen w-full flex items-center justify-center">
        <div className="w-[45%] pl-12">
            ...
            <h2 className="font-[font4] text-[3.7vh] mt-4 font-regular">Electronics and Telecommunication Department</h2>
        </div>
        <div className="flex w-[50%]">
            ...
            <div className="flex flex-col text-center relative -top-14 text-zinc-800 font-[font1]">
                ...
                <h3 className="text-[2.4vh] font-regular ">TELECOM ENGINEER'S STUDENT ASSOCIATION</h3>
                <h3 className="text-[2.3vh] font-regular  -mt-1">WE CREATE.YOU CELEBRATE</h3>
            </div>
        </div>
      </div>
    </div>
