    ...
    <div className=" font-sans p-4 mt-32">
      <div className="w-full ">
        ...
        <div className="flex justify-center gap-4 mt-12">
          <button className="bg-[#4c8069] text-white font-semibold px-8 py-3 rounded-lg hover:bg-[#3b6654] transition-all duration-300 transform hover:scale-105 shadow-lg">
            View Placements
          </button>
