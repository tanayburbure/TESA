  ...
  return (
    <div className='fixed w-screen pt-16 px-8 z-[9999]'>
      ...
      <div className='fixed top-8 left-8 flex items-center'>
        <img ref={imgRef} className='w-12 select-none mix-blend-difference' src='/images/tesahalf.png' alt='TESA Logo' />
        <div className='h-12 w-24 mb-2 overflow-hidden'>
          <h2 ref={titleRef} className='select-none font-[font1] text-zinc-900 font-semibold pl-2 text-[4.4vh]'>TESA</h2>
        </div>
      </div>
