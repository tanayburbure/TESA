...
function Nav() {
  ...
  return (
    <div className='fixed no-draw w-screen pt-16 px-8 z-[9999]'>
      ...
      <div className='fixed top-8 right-8 group'>
        ...
        {/* Menu Button */}
        <div className='p-7 no-draw rounded-md bg-[#2A2929] text-white cursor-pointer transition-all duration-300 hover:bg-gray-700'>
