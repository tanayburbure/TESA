...
const ThreeScene = () => {
  ...
  return (
    <div ref={canvasRef} className="absolute z-[2] inset-0"></div>
  );
};

// Main Component - SOLUTION 1
const Home = () => {
  const blinkRef = useRef(null);
  const h1Ref = useRef(null);
  ...
  return (
    <div className="w-full">
      ...
      <div className="h-[80vh] relative z-[1]">
        <Spotlight 
      ...
      {/* Second Section - Three.js Scene with FIXED Z-INDEX */}
      <div className="landing w-screen relative flex flex-col min-h-screen">
        <div className="flex items-center justify-center">
          <h1
            ref={h1Ref}
            className="text-[7vh] font-[font4] text-center absolute font-semibold tracking-tight pt-[65vh] z-[10] text-white"
          >
