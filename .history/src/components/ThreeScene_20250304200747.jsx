...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      sphereRef.current.position.y = 0.5 - scrollY * 0.1; // Adjust the multiplier for speed

      // Move h2 element like a 3D element
      const h2PositionY = 12 - (scrollY * 0.1 * 0.3); // Adjust the multiplier for movement
