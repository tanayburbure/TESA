...
const ScrollBgTransition = () => {
  ...
  return (
    <div ref={containerRef} className="relative h-[70vh] flex items-center justify-center bg-[#EBEBEB]">
      {/* Black Overlay with shadow effect */}
      <div
        ref={overlayRef}
        className="absolute bottom-0 left-0 w-full h-0 bg-black"
        style={{
          maskImage: "linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 60%)",
