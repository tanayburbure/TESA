...
/**
 * MouseTrail
 * - Full-screen canvas drawing a pencil-like trail following pointer/touch
 * - Smooth curves, per-point lifetime (fade-out), variable width
 * - Handles devicePixelRatio for crisp rendering
 *
 * Usage: import MouseTrail from './MouseTrail' and include <MouseTrail /> somewhere in your app.
 *
 * Props you can tweak:
 * - color (string) - stroke color (default: "#111")
 * - maxWidth (number) - max stroke width in px (default: 12)
 * - minWidth (number) - min stroke width (default: 2)
 * - ttl (number) - lifetime of a trail point in ms (default: 900)
 * - spacing (number) - minimum pixel distance between stored points (default: 2)
 */
