    ...
    <div className='h-[100vh] relative flex bg-[#EBEBEB]'>
      ...
      <div className='absolute px-10 text-center flex flex-col items-center justify-center'>
        ...
        <div className='mt-8 flex gap-16 z-[1]'>
          <button className="relative overflow-hidden border-2 border-zinc-700 font-[font4] px-5 pt-[5px] rounded-full mx-2 text-zinc-700 transition-all duration-300 transform scale-100 hover:scale-105 hover:border-transparent hover:text-indigo-900 group">
            {/* Sliding background */}
