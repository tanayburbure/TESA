...
const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-28 px-4 w-full left-0 top-0">
      ...
      <a 
  className="z-[999999] inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors" 
  href="https://docs.google.com/forms/d/e/1FAIpQLSdiPRCJnQJWgy-HcWOuGQEfA5LHrx_3CxFpiDlSpJNJXLUt0Q/viewform"
  target="_blank"
