...
const HeroParallax = ({ products }) => {
    ...
    const translateY = useSpring(
        useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [-700, 500, 500, 1000]),
        springConfig
    );
    ...
    return (
        <div
            ref={ref}
            className="h-[300vh] select-none py-72 overflow-hidden antialiased relative flex flex-col self-auto [perspective:900px] [transform-style:preserve-3d]"
        >
            <Header />
            <motion.div
                style={{
...
const Header = () => {
    return (
        <div className="max-w-7xl z-[1] relative mx-auto  md:py-28 px-4 w-full left-0 top-0">
