            ...
            <div className="fixed top-6 right-6 z-[99999]">
                ...
                >
                    {isHovered && (
                        ...
                        >
                            {['Home', 'About Us', 'Domain', 'Events', 'Interview Exp', 'Startups'].map((item, index) => (
                                <motion.li
                                    key={index}
                                    className={`transition-colors duration-300 ${hoveredItem !== null && hoveredItem !== index ? 'text-zinc-600' : ''
                                        }`}
