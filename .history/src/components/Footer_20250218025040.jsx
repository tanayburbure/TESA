...
function Footer() {
  return (
    <div className="h-[75vh] lg:h-[50vh] md:h-[73vh] overflow-hidden">
      ...
      <div className="py-[3vh] lg:flex lg:justify-between lg:items-center lg:pl-20 flex flex-col lg:flex-row">
        {/* Logo Section */}
        <div className="py-[5vh] flex flex-col items-center text-zinc-400 font-[font15] lg:w-1/3">
          <motion.img
        ...
        {/* Socials Section */}
        <div className="flex flex-col items-center lg:ml-12 lg:w-1/3">
        ...
        {/* Address Section */}
        <div className="flex flex-col items-center mt-12 lg:mt-0 lg:pr-16 lg:items-start lg:w-1/3">
