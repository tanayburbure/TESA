...
function Nav() {
  ...
  useEffect(() => {
    gsap.to(titleRef.current, {
      x: '-150px', // Moves left by 100px
      opacity: 0.8,
      duration: 1,
      ease: 'power2.out',
      scrollTrigger: {
        trigger: titleRef.current,
        start: 'top 00%', // Adjusted trigger start
        end: 'top 40%',  // Adjusted end for smooth effect
        scrub: 1, // Slows down the scrolling effect
  ...
  return (
    <div className='flex relative justify-between items-center pt-8 px-8'>
      <div className='flex items-center px-3 z-[99999999] py-[2.2vh]'>
        ...
        <div className='kite h-12 w-20 bg-red-300 fixed ml-16 overflow-hidden'> {/* Added overflow-hidden to kite div */}
          <h2 ref={titleRef} className='select-none text-zinc-200 text-2xl'>TESA</h2>
        </div>
      </div>
