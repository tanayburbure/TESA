...
export const products = [
  ...
  },
  {
    ...
    thumbnail: "https://aceternity.com/images/products/thumbnails/new/tanayweb.png",
...
const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="h-[350vh] py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-black text-white"
    >
      <Header />
      <motion.div
        style={{
