...
const HeroParallax = ({ products }) => {
  ...
  // match original spacing logic
  const cardWidthRem = 32;
  const gapRem = 5;
  const viewportApproxRem = 100;
    ...
    <section ref={sectionRef} className="relative h-[100vh]">
      <div className="sticky top-0 h-screen overflow-hidden flex flex-col [perspective:1000px] [transform-style:preserve-3d]">
        ...
        <div className="flex justify-center relative">
          ...
          <h2 ref={titleRef} className="sr-only" aria-hidden>
            Startup Promotion
          </h2>
  ...
  return (
    <div className="max-w-7xl z-[1] relative mx-auto py-10 md:py-16 px-4 w-full left-0 top-0">
      ...
      <h1 className="text-2xl font-[font2] md:text-6xl font-bold">
        <span className="text-[#3B6654] font-[font1] md:text-[10vh] font-bold">STARTUP</span>{" "}
        Promotion
      </h1>
