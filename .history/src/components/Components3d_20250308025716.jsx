    ...
    <div>
      <div ref={containerRef} style={{ height: '140vh' }} className="text-center text-white pt-[30vh] bg-[#EBEBEB] relative">
        <div 
          ...
          style={{
            background: '#18181B',
            clipPath: 'polygon(0% 25%, 5% 15%, 10% 25%, 20% 15%, 30% 25%, 40% 15%, 50% 25%, 60% 15%, 70% 25%, 80% 15%, 90% 25%, 95% 15%, 100% 25%, 100% 100%, 0% 100%)',
            ...
            '&:hover': {
              clipPath: 'polygon(0% 20%, 5% 10%, 10% 20%, 20% 10%, 30% 20%, 40% 10%, 50% 20%, 60% 10%, 70% 20%, 80% 10%, 90% 20%, 95% 10%, 100% 20%, 100% 100%, 0% 100%)'
            }
          }}
        >
        </div>
