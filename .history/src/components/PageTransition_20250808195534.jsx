...
const PageTransition = ({
  ...
  return (
    <Tag
      ...
      className={cn(
        "relative flex rounded-full border border-white/20 bg-black/20 dark:bg-white/20 transition duration-500 hover:bg-black/10 items-center justify-center p-px w-fit h-min overflow-visible",
        containerClassName
      )}
      {...props}
    >
