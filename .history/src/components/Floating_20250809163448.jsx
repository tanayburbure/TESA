...
const Floating = () => {
  ...
  const [logos] = useState([
    ...
    { id: 1, alt: 'TypeScript', imageUrl: './vscode.png', top: 20, left: 20, filterColor: '#007ACC', animationDelay: '0s' },
    ...
    { id: 4, alt: 'Bitcoin', imageUrl: './python.png', top: 60, left: 70, filterColor: '#F7931A', animationDelay: '1.5s' },
