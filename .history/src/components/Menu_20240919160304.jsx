  ...
  return (
    <div className="relative">
      ...
      <div className="group flex justify-start">
        ...
        <div className="fixed top-0 right-0 w-0 h-screen bg-gray-800 p-4 opacity-0 pointer-events-none transform translate-x-full transition-all duration-300 group-hover:w-1/2 group-hover:opacity-100 group-hover:translate-x-0 group-hover:pointer-events-auto">
