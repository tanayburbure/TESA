    ...
    <>
      ...
      <svg
        className={cn(
          ...
          // Keeping original dimensions: h-[110%] w-[200%] lg:w-[100%]
          className
        )}
      ...
      >
        <g filter="url(#filter)">
          <ellipse
            // Keeping original ellipse properties unchanged
            cx="1924.71"
            cy="273.501"
            rx="1924.71"
            ry="273.501"
...
const Home = () => {
  return (
    <div className="h-[80vh] z-1 overflow-x-hidden">
      {/* Added overflow-x-hidden to prevent horizontal scrolling */}
      
      {/* Keeping original Spotlight positioning: top-0 left-[10%] */}
      <Spotlight 
      ...
      <div className="h-screen w-full flex items-center justify-center">
        {/* Keeping original layout structure unchanged */}
        ...
        <div className="flex w-[50%] pl-8">
          {/* Keeping original image and text positioning */}
