  ...
  return (
    <>
      ...
      <div className="landing relative flex justify-center">
        ...
        <h3 className="text-zinc-700 font-semibold text-[1.8vw] absolute top-[68vh]">TELECOM ENGINEER STUDENTS ASSOCIATION</h3>
        <h2 className="text-[2.5vw] font-bold text-zinc-800 absolute top-[75vh]">WE CREATE. YOU CELEBRATE.</h2>
      </div>
    </>
  );
};
