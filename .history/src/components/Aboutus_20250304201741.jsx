    ...
    <div className='h-[120vh] relative flex'>
      ...
      <div className='absolute px-10 text-center flex flex-col items-center justify-center'>
        ...
        <div className='flex flex-col items-center mt-32'>
          ...
          <p ref={paragraphRef} className='w-[75%] text-[2.8vh] mt-[30vh] tracking-tight leading-[3.7vh] text-zinc-400'>The Telecom Engineers Student Association (TESA) has proudly upheld its legacy for many years. <br />
