...
const Spotlight = ({
  ...
  return (
    <>
      ...
      <svg
        className={cn(
          /* CHANGED: Increased width from w-[200%] to w-[600%] (3x wider) */
          /* CHANGED: Increased lg width from lg:w-[84%] to lg:w-[252%] (3x wider) */
          "animate-spotlight pointer-events-none absolute  h-[110%] w-[600%] lg:w-[252%] opacity-0",
          className
        )}
      ...
      >
        <g filter="url(#filter)">
          <ellipse
            cx="1924.71"
            cy="273.501"
            /* CHANGED: Increased horizontal radius from 1924.71 to 5774.13 (3x wider) */
            rx="5774.13"
            ry="273.501"
