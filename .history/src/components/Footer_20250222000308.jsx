      ...
      <div className="py-[3vh] lg:flex lg:justify-between lg:items-center lg:pl-20">
        ...
        <div className="flex flex-col items-center lg:ml-12">
          ...
          <div className="flex gap-8 text-[5.5vw] lg:text-[1.5vw]">
            <motion.a
              className="relative text-white lg:p-8 lg:border-[1px] lg:border-[#2A2929] lg:overflow-hidden lg:bg-[#2A2929] transition-all duration-300 group"
            ...
            >
              ...
              <motion.span
                className="lg:absolute lg:-inset-1 lg:bg-[#FF2648] lg:transform lg:translate-y-full lg:group-hover:translate-y-0 lg:transition-transform lg:duration-300 lg:z-0"
            ...
            >
              ...
              <motion.span
                className="lg:absolute lg:-inset-1 lg:bg-blue-500 lg:transform lg:translate-y-full lg:group-hover:translate-y-0 lg:transition-transform lg:duration-300 lg:z-0"
                initial={{ translateY: '100%' }}
                animate={{ translateY: '0' }}
              ></motion.span>
            </motion.a>
            ...
            >
              ...
              <motion.span
                className="lg:absolute lg:-inset-1 lg:bg-[#6228d7] lg:transform lg:translate-y-full lg:group-hover:translate-y-0 lg:transition-transform lg:duration-300 lg:z-0"
                initial={{ translateY: '100%' }}
                animate={{ translateY: '0' }}
              ></motion.span>
            </motion.a>
      ...
      <div>
        ...
        <div className="flex items-center justify-between font-[font1] text-[2.1vw] lg:text-[1.3vw] text-zinc-600 lg:flex-row lg:justify-between lg:items-center lg:px-16 px-2">
          ...
          <div className="text-center">
            ...
            <a className=" text-zinc-500 text-[1.2vh] flex items-center justify-center lg:text-[1.3vw] text-sm lg:text-[2.2vh] lg:text-zinc-500">
