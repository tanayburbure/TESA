  ...
  useEffect(() => {
    gsap.to(titleRef.current, {
      ...
      scrollTrigger: {
        ...
        start: 'top 50%', // Starts at center of viewport
        end: 'top 10%', 
        scrub: 1,
