...
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      // Move the h2 element with scrolling
      const h2Element = document.querySelector('.scrolling-h2');
      if (h2Element) {
        h2Element.style.transform = `translateY(${scrollY * 0.001}px)`; // Adjust the multiplier for speed
      }
    };
    ...
    <div className="w-full">
      <div className="landing w-screen relative flex flex-col">
        <div className="flex items-center justify-center">
          <h2 className="scrolling-h2 text-[2.5vw] z-[3] font-bold text-zinc-800 text-center absolute cursor-pointer pt-12">WE CREATE. YOU CELEBRATE.</h2>
