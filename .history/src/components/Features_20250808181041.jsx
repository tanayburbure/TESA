...
const Card = ({ className, children }) => (
  <div
    className={cn(
      "rounded-2xl h-[30vh] w-84 p-4 overflow-hidden bg-black border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
      className
    )}
  >
          ...
          >
            ...
            <Card className="bg-white text-zinc-900 h-60">
              <div className="flex items-center gap-2 ">
                ...
                {icon && <div className="text-3xl text-[#3B6654]">{icon}</div>}
              </div>
