...
const ProductCard = ({ product, translate }) => {
    return (
        <motion.div
            ...
            key={product.title}
            className="group/product bg-zinc-900 h-[28rem] w-[30rem] relative shrink-0"
        >
            <a
                href={product.link}
            ...
            <div className="absolute top-[55%] p-4 rounded-xl group-hover/product:opacity-100 text-white w-full ">
