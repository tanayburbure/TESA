...
const Header = () => {
  return (
    <div className="max-w-7xl  relative mx-auto py-20 md:py-28 px-4 w-full left-0 top-0">
      <h1 className="text-2xl z-[9] font-[font2] md:text-6xl font-bold ">
        The Ultimate 
      </h1><h1 className="text-2xl z-[9] font-[font2]  md:text-6xl font-bold">
        <span className="text-[#3B6654] font-[font1] md:text-[10vh] font-bold">STARTUP</span> Promotion
      </h1>
      <h3 className="pt-1 z-[9] text-2xl font-[font3]">presented by <span className="text-[#3B6654] font-bold">TESA</span></h3>
      <h3 className="text-2xl font-[font1] pt-2 font-medium">INNOVATE | COLABORATE | TRANSFORM</h3>
      <button 
  className=" px-4 py-2 z-[9] bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors"
