...
function Highlights() {
    return (
        <div className='flex flex-col mt-8 bg-zinc-900 h-[70vh] items-center justify-start text-white'>
            ...
            <h3 className='text-center text-[2.4vh]'>Our website is equipped with highly impactful features, thoughtfully designed to enhance student experience and usability.</h3>
