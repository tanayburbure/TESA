    ...
    <div className="wrapper relative overflow-x-hidden">
      <div className="page5">
        <div ref={sectionRef} id="page5" className="relative h-screen w-full overflow-hidden">
          <h1 className="text-[#103289] text-[10vw] font-medium leading-[4vw] tracking-[-1vh] absolute top-[32%] font-[font1] pt-[10vh] pl-[14vw]">
            OUR CORE TEAM
          </h1>
          {/* Only images move */}
          <div
            ...
            className="mt-[9vh] w-[300%] h-[60%] gap-[2vw] pl-[90vw] relative flex justify-center items-center"
          >
          <img className="h-[100vh] w-[120vw] absolute left-0 -top-[12vh]" src="public\team.png" alt="" />
            {[
