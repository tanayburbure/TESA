...
function Thoughts() {
  ...
  return (
    <div className='h-[100vh] text-white z-[99999999] bg-zinc-900 flex flex-col items-center'>
      ...
      <div className="flex justify-between w-full z-9999 cursor-pointer mt-4">
        <button onClick={prevStudent} className="bg-blue-500 text-white px-4 py-2 rounded">Previous</button>
        <button onClick={nextStudent} className="bg-blue-500 text-white px-4 py-2 rounded">Next</button>
      </div>
    </div>
  );
}
