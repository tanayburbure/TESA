            ...
            <div ref={sectionRef} className="relative h-screen w-full overflow-hidden z-10">
                ...
                >
                    <div
                        ...
                        // Current: pr-10 (padding-right: 2.5rem = 40px)
                        // Options:
                        // pr-4 = 16px, pr-8 = 32px, pr-12 = 48px, pr-16 = 64px, pr-20 = 80px
                        // OR use pr-[5vw] for 5% viewport width, pr-[10vw] for 10%, etc.
                        // OR use transform in style for pixel-perfect positioning
                        className="flex space-x-20 pr-10"
                        style={{ 
                            width: "fit-content",
                            willChange: "transform",
                            // POSITIONING METHOD 3: Use transform for precise positioning
                            // Uncomment and adjust the translateX value as needed:
                            // transform: "translateX(-200px)", // Move 200px left
