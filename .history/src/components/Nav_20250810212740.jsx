...
function Nav() {
  ...
  return (
    <div className='fixed select-none w-screen pt-16 px-8 z-[9999]'>
      {/* Logo & Title */}
      <div className='fixed top-6 left-8 flex items-center'>
        <img 
          ref={imgRef} 
          className='w-12 select-none' 
          src='/images/tesahalf.png' 
          alt='TESA Logo'
          style={{ willChange: 'auto' }} // Prevent unnecessary layer promotion
        />
