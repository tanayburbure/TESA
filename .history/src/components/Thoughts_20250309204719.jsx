...
function Thoughts() {
  ...
  return (
    <div className='h-[100vh] text-white bg-zinc-900 flex flex-col items-center'>
      <h1 className='text-[6vh] font-semibold text-center font-[font3]'>Thoughts of Our STUDENTS</h1>
      <div className='flex flex-nowrap justify-center gap-8 mt-12'>
      ...
      <div className="flex justify-between w-full z-9999 mt-4">
        <button onClick={prevStudent} className="bg-blue-100 hover:bg-blue-700 text-white px-4 py-2 rounded cursor-pointer">Previous</button>
        <button onClick={nextStudent} className="bg-blue-500 text-white px-4 py-2 rounded cursor-pointer">Next</button>
      </div>
    </div>
  );
}
