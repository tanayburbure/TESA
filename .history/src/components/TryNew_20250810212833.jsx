...
export default function HamburgerMenu() {
  ...
  return (
   <div className=' fixed relative top-6 left-[94.2%]'>
     <motion.div
      className=" w-16 h-16 cursor-pointer flex flex-col justify-center items-center bg-gray-800 rounded-lg  transition-colors"
