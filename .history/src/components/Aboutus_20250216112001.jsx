...
function Aboutus() {
  return (
    <div className='text-white h-[100vh] px-24 pt-32'>
      <div className='flexed items-center justify-between'>
        <h1 className='text-[6vh] font-bold'>WE ARE</h1>
        <p className='pt-12 pr-20 text-[2.3vh]'>TESA (Telecom Engineers Student Association) has been carrying on its legacy for many years.
          <br />
