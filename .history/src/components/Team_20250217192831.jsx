      ...
      if (sectionRef.current && imageContainerRef.current) {
        ...
        const tl = gsap.timeline({
          scrollTrigger: {
            ...
            pin: imageContainerRef.current, // Pinning the image container
    ...
    <div className="wrapper relative overflow-x-hidden">
      <div className="page5">
        <div ref={sectionRef} id="page5" className="relative h-screen w-full bg-white overflow-hidden">
          {/* Fixed text position */}
          <h1 className="fixed top-8 left-5 text-[#103289] text-3.7vw leading-[4vw] tracking-[-0.2vh] text-left font-normal font1">
            WELCOME TO QUALCOMM
          </h1>
          <h2 className="fixed top-24 right-5 text-3.1vw font-normal font2 leading-[3.2vw] tracking-[-1px] text-[#e2e2e28b]">
            Discover our diverse range of
          </h2>
          <h2 className="fixed top-32 right-5 text-3.1vw font-normal font2 leading-[3.2vw] tracking-[-1px] text-[#e2e2e28b]">
