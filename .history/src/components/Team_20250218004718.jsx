...
const teamImages = [
  { src: "./images/principale.png", category: "Principal", position: "top: 10%; left: 10%;" },
  { src: "./images/hod.png", category: "Head of Department", position: "top: 20%; left: 20%;" },
  { src: "./images/itole-sir.jpg", category: "TESA Chairperson", position: "top: 30%; left: 30%;" },
  { src: "./images/Gajare-sir.jpg", category: "TESA Chairperson", position: "top: 40%; left: 40%;" },
  { src: "./images/Madhavi Shinde_.jpg", category: "President", position: "top: 50%; left: 50%;" },
  { src: "../images/Madhavi Shinde_.jpg", category: "Vice-President", position: "top: 60%; left: 60%;" },
  { src: "./images/Madhavi Shinde_.jpg", category: "General Secretary", position: "top: 70%; left: 70%;" },
  { src: "./images/Madhavi Shinde_.jpg", category: "Administrator", position: "top: 80%; left: 80%;" },
  { src: "./images/Madhavi Shinde_.jpg", category: "Treasurer", position: "top: 90%; left: 90%;" },
];
    ...
    const ctx = gsap.context(() => {
      if (sectionRef.current && imageContainerRef.current) {
        ...
        tl.to(imageContainerRef.current, {
          x: "-63%", // Move images while the section is pinned
        ...
        <div ref={sectionRef} className="relative h-screen w-full overflow-hidden">
          ...
          >
            ...
            {teamImages.map((image, index) => (
              <div key={index} className="elem border-[4px] mt-24 h-[45vh] relative rounded-[1vh] overflow-hidden" style={{position: "absolute", ...image.position}}>
