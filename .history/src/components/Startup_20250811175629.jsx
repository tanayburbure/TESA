...
const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-28 px-4 w-full left-0 top-0">
      ...
      <h3 className="pt-2 text-2xl font-[font3]">presented by <span className="text-[#3B6654]">TESA</span></h3>
      <h3 className="text-2xl font-[font2] pt-2">INNOVATE | COLABORATE | TRANSFORM</h3>
