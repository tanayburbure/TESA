    ...
    return (
        <div className='flex flex-col mt-8 bg-zinc-900 h-[80vh] items-center justify-start text-white'>
            ...
            <div className="flex gap-4 mt-24">
                <div className="h-[12vw] w-[18vw] px-4 mx-4 bg-[#FFFFFF] text-zinc-800 rounded-lg text-center">
                    <div className='text-[3.5vh] flex items-center gap-1 justify-center pt-3'>
                        <h2 className='text-[2.4vh]'>INTERVIEW EXPERIENCE</h2>
                        <IoIosPeople />
                    </div>
                ...
                <div className="h-[12vw] w-[18vw] px-4 mx-4 bg-[#FFFFFF] text-zinc-800 rounded-lg text-center">
                    <div className='text-[3.5vh] flex items-center gap-1 justify-center pt-3'>
                        <h2 className='text-[2.4vh]'>TESA REPORT</h2>
                        <TbReportAnalytics />
                    </div>
                    <p>An annual report meticulously prepared for our association, a comprehensive overview of all activities conducted.</p>
                    <button>View page</button>
                </div>
                <div className="h-[12vw] w-[18vw] mx-4 px-4 bg-[#FFFFFF] text-zinc-800 rounded-lg text-center">
                    <div className='text-[3.2vh] flex items-center gap-[0.5vh] justify-center pt-3'>
                        <h2 className='text-[2.4vh]'>STARTUP PAGE</h2>
                        <BsRocketTakeoffFill />
                    </div>
