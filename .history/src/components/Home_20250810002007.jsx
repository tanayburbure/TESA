...
// Assume these shader files exist and are correctly configured to be imported
// import vertexShadertwo from "../shaders/vertexShadertwo.glsl";
// import fragmentShadertwo from "../shaders/fragmentShadertwo.glsl";

// For this example, we'll use placeholder shaders as the originals aren't provided.
...
const fragmentShadertwo = `
  ...
  void main() {
    ...
    } else if (uColorChange < 1.5) {
      color = vec3(0.0, 1.0, 0.0); // Green
    } else {
      color = vec3(0.0, 0.0, 1.0); // Blue
    }
    gl_FragColor = vec4(color * abs(sin(uTime)), 1.0);
  }
`;
...
// Main App Component with both components merged
const Home = () => {
  return (
    <div>
