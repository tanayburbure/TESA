    ...
    <div className="h-[75vh] lg:h-[50vh] md:h-[73vh] overflow-hidden">
      ...
      <div className="py-[3vh] lg:flex lg:justify-between lg:items-center lg:pl-12">
        ...
        <div className="py-[5vh] flex flex-col items-center text-zinc-800 font-[font1]">
          <img
            className="h-[20vw] lg:h-[10vw] font-semibold mb-2 select-none transition-transform duration-300"
            src="./images\tesahalf.png"
            alt="TESA Logo"
          />
          <h3 className="text-[1.8vh]">TELECOM ENGINEER'S STUDENT ASSOCIATION</h3>
          <h2 className="text-[1.9vh]">WE CREATE.YOU CELEBRATE</h2>
        </div>
