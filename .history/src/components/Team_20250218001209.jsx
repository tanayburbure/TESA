    ...
    <div className="wrapper relative bg-black overflow-x-hidden">
      <div className="page5">
        <div ref={sectionRef} id="page5" className="relative h-screen w-full overflow-hidden">
          ...
          >
            <div className="border-t border-white h-[1px] w-full absolute left-[8vw] top-[40vh]"></div>
            <div className="border-t border-white h-[1px] w-full absolute left-[8vw] top-[60vh]"></div>
