            ...
            <div className='exp py-16'>
                ...
                <div className='cards grid grid-cols-1  gap-8 w-[70vw] mx-auto mt-8'>
                    {name.map((student, index) => (
                        <div key={index} className='h-[30vh] bg-white text-black p-6 rounded-lg'>
                            <div className='flex'>
                                <h3 className='text-xl font-bold '> {student}<span>Placed at </span></h3>
                                <p className='text-green-800 font-medium'>{job[index]}</p>
                            </div>
