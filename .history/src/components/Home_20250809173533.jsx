    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="h-screen w-full flex items-center justify-center">
        <div className="w-[50%] pl-16">
            <h3 className="font-[font2] text-[3.4vh]">Presented by</h3>
            <h2 className="font-[font4] text-[4.5vh] mt-5 font-regular">Electronics and Telecommunication Department</h2>
        </div>
