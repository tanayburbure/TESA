    ...
    <div className='h-[100vh] bg-green-200 relative flex flex-col  items-center justify-center'>
      ...
      <div className='absolute px-10'>
        ...
        <div className='flex justify-between mt-20'>
          <h1 className='text-[5.5vh]  font-bold pt-2 '><span className='font-medium pr-4 mb-2' ref={blinkRef}>[</span> WE ARE </h1>
          <p ref={paragraphRef} className='w-[60%] text-[2.7vh] text-[#A1A1AA] pr-8 tracking-tight leading-[3.5vh] text-zinc-800'>The Telecom Engineers Student Association (TESA) has proudly upheld its legacy for many years. <br />
