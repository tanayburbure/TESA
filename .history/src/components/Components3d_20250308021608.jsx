...
function Components3d() {
  ...
  return (
    <div>
      <div ref={containerRef} style={{ height: '150vh' }} className="text-center text-white pt-[30vh] relative">
        <div 
          ref={overlayRef}
          className="absolute bottom-36 left-0 w-full h-0"
          style={{
            background: '#18181B',
        ...
        <div className="absolute text-zinc-400 bg-[#18181B]"> 
