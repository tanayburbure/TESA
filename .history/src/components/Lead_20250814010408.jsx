...
const HeroParallax = ({ products }) => {
    ...
    const translateY = useSpring(
        useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [-10, 100, 100, 1000]),
        springConfig
    );
    ...
    return (
        <div className="max-w-7xl bg-transparent relative mx-auto py-20 md:py-60 px-4 w-full">
            <h1 className="text-2xl font-bold md:text-6xl">
                <span className="text-green-600 md:text-8xl font-bold">
                    STARTUP
                </span> Promotion
            </h1>
            <h3 className="pt-1 text-2xl">
                presented by <span className="text-green-600 font-bold">TESA</span>
            </h3>
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-6 left-6 right-6">
                <h2 className="text-2xl font-bold text-white p-2 rounded bg-black/50">
                    {product.title}
                </h2>
            </div>
        </motion.div>
...
const ParallaxScroll = ({ images, className }) => {
  ...
  return (
    <div className={`items-start w-full select-none ${className}`}>
      <h1 className="text-center text-8xl text-green-600 font-semibold mt-32">OUR EVENTS</h1>
