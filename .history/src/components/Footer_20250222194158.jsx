...
function Footer() {
  ...
  <span className="relative">
    ...
    <span className="absolute left-1/2 bottom-0 h-[1px] bg-zinc-500 transform scale-x-0 transition-transform duration-300 origin-center group-hover:scale-x-100"></span>
  </span>
