  ...
  return (
    <div className="w-full pt-12">
      <div className="w-[70vw] mx-auto">
        <h1 className="text-center tracking-tighter text-[3vw]">
          Learn from Real-Life <span className="text-green-800">INTERVIEW EXP</span> of our students
        </h1>
      ...
      <div className="exp py-16">
        <h2 className="text-center text-[3vw]">TOP INTERVIEW EXPERIENCES</h2>
        <div className="cards grid grid-cols-1 gap-8 w-[70vw] mx-auto mt-8">
