...
// Optional: Replace with `classnames` if you don't have `cn` from shadcn
function cn(...classes) {
...
export default function CometCardDemo({
  ...
  const glareBackground = useMotionTemplate`
    radial-gradient(circle at ${glareX}% ${glareY}%, rgba(255, 255, 255, 0.9) 10%, rgba(255, 255, 255, 0.75) 20%, rgba(255, 255, 255, 0) 80%)
  `;
  ...
  return (
    <div className={cn("perspective-distant transform-3d")}>
      <motion.div
        ref={ref}
